...
public class Product_VidvidVK : IProduct
{
	...
	public Product_VidvidVK()
	{
	}

	public Product_VidvidVK(JObject jObj)
	{
		...
		R = Convert.ToDouble(jObj.GetValue("R"));
		...
		ProfileType = jObj.GetValue("ProfileType")?.ToString();
