...
public class Product_TrijnykTRK : IProduct
{
	...
	public string TypeTRKinput { get; set; }

	public string TypeTRKoutput { get; set; }

	public string TypeTRKvrizka { get; set; }
	...
	public Product_TrijnykTRK()
	{
	}

	public Product_TrijnykTRK(JObject jObj)
	{
		...
		TypeTRKinput = jObj.GetValue("TypeTRKinput").ToString();
		TypeTRKoutput = jObj.GetValue("TypeTRKoutput").ToString();
		TypeTRKvrizka = jObj.GetValue("TypeTRKvrizka").ToString();
