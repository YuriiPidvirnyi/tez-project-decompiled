...
public class Product_PerehidnykPOLP_K : IProduct
{
	...
	public string TypProfilD { get; set; }

	public string Vidbortovka { get; set; }

	public string AisiType { get; set; }

	public Product_PerehidnykPOLP_K()
	{
	}

	public Product_PerehidnykPOLP_K(JObject jObj)
	{
		...
		TypProfilD = jObj.GetValue("TypProfilD").ToString();
