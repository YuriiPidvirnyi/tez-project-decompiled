...
public class Product_KlapanProtypogegnyjKPpEIS60m : IProduct
{
	...
	public string Kincevyk { get; set; }

	public Product_KlapanProtypogegnyjKPpEIS60m()
	{
	}

	public Product_KlapanProtypogegnyjKPpEIS60m(JObject jObj)
	{
		...
		Kincevyk = jObj.GetValue("Kincevyk")?.ToString();
	}
}
