...
public class Product_UtkaUAK : IProduct
{
	...
	public string TypMaterialOutput { get; set; }

	public string Vidbortovka { get; set; }

	public Product_UtkaUAK()
	{
	}

	public Product_UtkaUAK(JObject jObj)
	{
		...
		TypMaterialOutput = jObj.GetValue("TypMaterialOutput").ToString();
