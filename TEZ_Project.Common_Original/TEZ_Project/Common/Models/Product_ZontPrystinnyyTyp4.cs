...
public class Product_ZontPrystinnyyTyp4 : IProduct
{
	...
	public Product_ZontPrystinnyyTyp4()
	{
	}

	public Product_ZontPrystinnyyTyp4(JObject jObj)
	{
		...
		Implementation = Convert.ToInt32(jObj.GetValue("Implementation"));
