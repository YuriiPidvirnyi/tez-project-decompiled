...
public class Product_TrijnykTSHSP : IProduct
{
	...
	public string TypeTSHSPenter { get; set; }

	public string TypeTSHSPout { get; set; }
	...
	public Product_TrijnykTSHSP()
	{
	}

	public Product_TrijnykTSHSP(JObject jObj)
	{
		...
		TypeTSHSPenter = jObj.GetValue("TypeTSHSPenter").ToString();
		TypeTSHSPout = jObj.GetValue("TypeTSHSPout").ToString();
