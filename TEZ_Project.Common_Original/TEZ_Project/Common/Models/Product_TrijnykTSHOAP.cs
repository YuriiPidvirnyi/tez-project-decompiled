...
public class Product_TrijnykTSHOAP : IProduct
{
	...
	public string TypeTSHOAPenter { get; set; }

	public string TypeTSHOAPleft { get; set; }

	public string TypeTSHOAPright { get; set; }
	...
	public Product_TrijnykTSHOAP()
	{
	}

	public Product_TrijnykTSHOAP(JObject jObj)
	{
		...
		H2 = Convert.ToInt32(jObj.GetValue("H2"));
		...
		TypeTSHOAPenter = jObj.GetValue("TypeTSHOAPenter").ToString();
		TypeTSHOAPleft = jObj.GetValue("TypeTSHOAPleft").ToString();
		TypeTSHOAPright = jObj.GetValue("TypeTSHOAPright").ToString();
