...
public class Product_AluminiumGrid : IProduct
{
	...
	public string TypReshitky { get; set; }
	...
	public bool Anodovane { get; set; }

	public string SposibKriplennja { get; set; }

	public bool NotRegular { get; set; }

	public bool Fasadna { get; set; }

	public bool HasSitka { get; set; }

	public Product_AluminiumGrid()
	{
	}

	public Product_AluminiumGrid(JObject jObj)
	{
		...
		TypReshitky = jObj.GetValue("TypReshitky").ToString();
		B = Convert.ToInt32(jObj.TryGetValue("B", out JToken value) ? value : jObj.GetValue("C"));
		H = Convert.ToInt32(jObj.TryGetValue("H", out JToken value2) ? value2 : jObj.GetValue("D"));
		RAL = jObj.GetValue("RAL").ToString();
		Anodovane = Convert.ToBoolean(jObj.GetValue("Anodovane"));
		SposibKriplennja = jObj.GetValue("SposibKriplennja").ToString();
		NotRegular = Convert.ToBoolean(jObj.GetValue("NotRegular"));
		Fasadna = Convert.ToBoolean(jObj.GetValue("Fasadna"));
		HasSitka = Convert.ToBoolean(jObj.GetValue("HasSitka"));
	}
}
