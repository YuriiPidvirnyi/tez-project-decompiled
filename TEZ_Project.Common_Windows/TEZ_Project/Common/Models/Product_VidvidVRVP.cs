...
public class Product_VidvidVRVP : IProduct
{
	...
	public string TypProfile { get; set; }

	public string TypProfile1 { get; set; }
	...
	public Product_VidvidVRVP()
	{
	}

	public Product_VidvidVRVP(JObject jObj)
	{
		...
		TypProfile = jObj.GetValue("TypProfile").ToString();
		TypProfile1 = jObj.GetValue("TypProfile1").ToString();
