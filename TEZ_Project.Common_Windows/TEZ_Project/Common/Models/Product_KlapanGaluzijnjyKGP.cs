...
public class Product_KlapanGaluzijnjyKGP : IProduct
{
	...
	public Product_KlapanGaluzijnjyKGP()
	{
	}

	public Product_KlapanGaluzijnjyKGP(JObject jObj)
	{
		...
		VydKGP = jObj.GetValue("VydKGP")?.ToString();
