...
public class Product_TrijnykTSSHP : IProduct
{
	...
	public string TypeTSSHPenter { get; set; }

	public string TypeTSSHPout { get; set; }
	...
	public Product_TrijnykTSSHP()
	{
	}

	public Product_TrijnykTSSHP(JObject jObj)
	{
		...
		TypeTSSHPenter = jObj.GetValue("TypeTSSHPenter").ToString();
		TypeTSSHPout = jObj.GetValue("TypeTSSHPout").ToString();
