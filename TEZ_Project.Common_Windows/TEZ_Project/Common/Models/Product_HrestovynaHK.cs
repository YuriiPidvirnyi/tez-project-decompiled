...
public class Product_HrestovynaHK : IProduct
{
	...
	public string TypeHKinput { get; set; }

	public string TypeHKout { get; set; }

	public string TypeHKvrizkaUp { get; set; }

	public string TypeHKvrizkaDown { get; set; }
	...
	public Product_HrestovynaHK()
	{
	}

	public Product_HrestovynaHK(JObject jObj)
	{
		...
		TypeHKinput = jObj.GetValue("TypeHKinput").ToString();
		TypeHKout = jObj.GetValue("TypeHKout").ToString();
		TypeHKvrizkaUp = jObj.GetValue("TypeHKvrizkaUp").ToString();
		TypeHKvrizkaDown = jObj.GetValue("TypeHKvrizkaDown").ToString();
