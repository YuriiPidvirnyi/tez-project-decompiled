...
public class Product_TrijnykTOZP : IProduct
{
	...
	public string TypeTOZPenter { get; set; }

	public string TypeTOZPout { get; set; }

	public string TypeTOZPvidvid { get; set; }
	...
	public Product_TrijnykTOZP()
	{
	}

	public Product_TrijnykTOZP(JObject jObj)
	{
		...
		TypeTOZPenter = jObj.GetValue("TypeTOZPenter").ToString();
		TypeTOZPout = jObj.GetValue("TypeTOZPout").ToString();
		TypeTOZPvidvid = jObj.GetValue("TypeTOZPvidvid").ToString();
