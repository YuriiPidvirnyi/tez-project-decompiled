...
public class ZontPrystinnyyTyp2
{
	...
	public static double[,] MaterialZontPrystinnyyTyp2(int L, int B, int H, int h, int number, string markaStaliZont, string tovchynaMetaluZont, string connection, string zlyv, string fastening, string vyhid, string vyhid1, int d1, int a1, int b1, int p1, int f1, int g1, string typVyhid1, string profilType1, string vyhid2, int d2, int a2, int b2, int p2, int f2, int g2, string typVyhid2, string profilType2, string vyhid3, int d3, int a3, int b3, int p3, int f3, int g3, string typVyhid3, string profilType3, string zhyrFiltr, int G, string markaStaliFiltr, string tovchynaMetaluFiltr)
	{
		...
		if (zhyrFiltr == "так")
		{
			...
			num10 = ((ZontPrystinnyyTyp2.l > 1230) ? 20 : 0);
			num10 += (double)(ZontPrystinnyyTyp2.l + 30);
		...
		if (connection == "заклепка")
		{
			...
			int num22 = (int)Math.Ceiling(((double)H - 2.0 * (double)num20) / (double)num21) + (int)Math.Ceiling(((double)B - 2.0 * (double)num20) / (double)num21) + (int)Math.Ceiling((num9 - 2.0 * (double)num20) / (double)num21) + (int)Math.Ceiling(((double)h - 2.0 * (double)num20) / (double)num21);
			num22 *= 2;
			if (zhyrFiltr == "так")
			{
				num22 += 4;
				num22 += 2 * (int)Math.Ceiling(((double)L - 100.0) / 200.0);
			}
			num++;
		...
		if (zhyrFiltr == "так")
		{
			...
			{
				array2 = FiltrZh.MaterialFiltrZh(kFiltr[k], ZontPrystinnyyTyp2.l, markaStaliFiltr, tovchynaMetaluFiltr, number);
	...
	public static void ZontPrystinnyyTyp2DrawDxf(int L, int B, int H, int h, string connection, string zlyv, string vyhid, string vyhid1, int d1, int a1, int b1, int f1, int g1, string typVyhid1, string vyhid2, int d2, int a2, int b2, int f2, int g2, string typVyhid2, string vyhid3, int d3, int a3, int b3, int f3, int g3, string typVyhid3, string zhyrFiltr, int G, string filePath)
	{
		ushort num = 566;
		string text = "0";
		double num2 = 0.0;
		...
		try
		{
			...
			double num18 = Math.Atan((double)(H - h) / ((double)B - num12));
			double num19 = 0.0;
			double num20 = 0.0;
			num2 = num17;
			num3 = (double)H + num17 - (double)h;
			num4 = num2 - num17;
			num5 = num3 + num17;
			ushort num21 = (ushort)(num + 1);
			num = num21;
			DrawLine(streamWriter, num21, text, num19 + num2, num20 + num3, num19 + num4, num20 + num5);
			num2 = num4;
			num3 = num5;
			num4 = num2;
			num5 = num3 + (double)h - 2.0 * num17;
			num21 = (ushort)(num + 1);
			num = num21;
			DrawLine(streamWriter, num21, text, num19 + num2, num20 + num3, num19 + num4, num20 + num5);
			num = DrawZaklepka(streamWriter, num, text, connection, num2 + num19, num3 + num20, num4 + num19, num5 + num20, 1);
			num2 = num4;
			num3 = num5;
			num4 = num2 + 2.0 * num17;
			num5 = num3 + 2.0 * num17;
			...
			else
			{
				num2 = num4;
				num3 = num5;
				num4 = num2 - (num12 - 2.0 * num17);
				num5 = num3;
				num21 = (ushort)(num + 1);
				num = num21;
				DrawLine(streamWriter, num21, text, num19 + num2, num20 + num3, num19 + num4, num20 + num5);
				num = DrawZaklepka(streamWriter, num, text, connection, num4 + num19, num5 + num20, num2 + num19, num3 + num20, 0);
				num2 = num4;
				num3 = num5;
				num4 = num2 - num17;
				num5 = num3 + num17;
			...
			double num24 = num4;
			double num25 = num5;
			double num26 = Math.Sqrt(Math.Pow((double)B - num12, 2.0) + Math.Pow(H - h, 2.0));
			if (zhyrFiltr == "ні")
			{
				if (connection == "заклепка")
				{
					num2 = num17;
					num3 = (double)H + num17 - (double)h;
					num4 = num2 - Math.Sqrt(2.0) * num11 * Math.Cos(Math.PI * 3.0 / 4.0 - num18);
					num5 = num3 - Math.Sqrt(2.0) * num11 * Math.Sin(Math.PI * 3.0 / 4.0 - num18);
					num21 = (ushort)(num + 1);
					num = num21;
					DrawLine(streamWriter, num21, text, num19 + num2, num20 + num3, num19 + num4, num20 + num5);
					num2 = num4;
					num3 = num5;
					num4 = num2 - num10 * Math.Sin(num18);
					num5 = num3 - num10 * Math.Cos(num18);
					num21 = (ushort)(num + 1);
					num = num21;
					DrawLine(streamWriter, num21, text, num19 + num2, num20 + num3, num19 + num4, num20 + num5);
					num2 = num4;
					num3 = num5;
					num4 = num2 + (num26 - 2.0 * num11) * Math.Cos(num18);
					num5 = num3 - (num26 - 2.0 * num11) * Math.Sin(num18);
					num21 = (ushort)(num + 1);
					num = num21;
					DrawLine(streamWriter, num21, text, num19 + num2, num20 + num3, num19 + num4, num20 + num5);
					num2 = num4;
					...
					num2 = num4;
					num3 = num5;
					num4 = num2 + Math.Sqrt(2.0) * num11 * Math.Cos(num18 - Math.PI / 4.0);
					num5 = num3 - Math.Sqrt(2.0) * num11 * Math.Sin(num18 - Math.PI / 4.0);
					num21 = (ushort)(num + 1);
					num = num21;
					DrawLine(streamWriter, num21, text, num19 + num2, num20 + num3, num19 + num4, num20 + num5);
				}
				else
				{
					...
					num4 = num2 + Math.Sqrt(2.0) * num11 * Math.Cos(num18 - Math.PI / 4.0);
					num5 = num3 - Math.Sqrt(2.0) * num11 * Math.Sin(num18 - Math.PI / 4.0);
					num2 = num4 - num11 * Math.Sin(num18);
					num3 = num5 - num11 * Math.Cos(num18);
					num21 = (ushort)(num + 1);
					num = num21;
					DrawLine(streamWriter, num21, text, num19 + num2, num20 + num3, num19 + num4, num20 + num5);
					num4 = num2 - Math.Sqrt(2.0) * num10 * Math.Cos(Math.PI / 4.0 - num18);
					num5 = num3 - Math.Sqrt(2.0) * num10 * Math.Sin(Math.PI / 4.0 - num18);
					num21 = (ushort)(num + 1);
					num = num21;
					DrawLine(streamWriter, num21, text, num19 + num2, num20 + num3, num19 + num4, num20 + num5);
					num21 = (ushort)(num + 1);
					num = num21;
					DrawLine(streamWriter, num21, text, num19 + num22, num20 + num23, num19 + num4, num20 + num5);
				}
			}
			else
			{
				if (connection == "заклепка")
				{
					num2 = num17;
					num3 = (double)H + num17 - (double)h;
					num4 = num2 + Math.Sqrt(2.0) * num17 * Math.Cos(num18 + Math.PI / 4.0);
					num5 = num3 - Math.Sqrt(2.0) * num17 * Math.Sin(num18 + Math.PI / 4.0);
					num21 = (ushort)(num + 1);
					num = num21;
					DrawLine(streamWriter, num21, text, num19 + num2, num20 + num3, num19 + num4, num20 + num5);
					num2 = num4;
					num3 = num5;
					num4 = num2 + (num15 - 2.0 * num17) * Math.Cos(num18);
					num5 = num3 - (num15 - 2.0 * num17) * Math.Sin(num18);
					num21 = (ushort)(num + 1);
					num = num21;
					DrawLine(streamWriter, num21, text, num19 + num2, num20 + num3, num19 + num4, num20 + num5);
					num = DrawZaklepka(streamWriter, num, text, connection, num2 + num19, num3 + num20, num4 + num19, num5 + num20, 0);
					num2 = num4;
					num3 = num5;
					num4 = num17 + num15 * Math.Cos(num18);
					num5 = (double)H + num17 - (double)h - num15 * Math.Sin(num18);
					num21 = (ushort)(num + 1);
					num = num21;
					DrawLine(streamWriter, num21, text, num19 + num2, num20 + num3, num19 + num4, num20 + num5);
				}
				...
				kk = 0.5 * ((double)L - kk) + 15.0;
				double num27 = ((G == B) ? kk : 20.0);
				num2 = num4;
				num3 = num5;
				num4 = num2 - (num27 - num9 / 2.0) * Math.Sin(num18);
				num5 = num3 - (num27 - num9 / 2.0) * Math.Cos(num18);
				num21 = (ushort)(num + 1);
				num = num21;
				DrawLine(streamWriter, num21, text, num19 + num2, num20 + num3, num19 + num4, num20 + num5);
				num2 = num4;
				num3 = num5;
				num4 = num2 + num9 * Math.Cos(num18);
				num5 = num3 - num9 * Math.Sin(num18);
				num21 = (ushort)(num + 1);
				num = num21;
				DrawLine(streamWriter, num21, text, num19 + num2, num20 + num3, num19 + num4, num20 + num5);
				num2 = num4;
				num3 = num5;
				num4 = num2 - num9 * Math.Sin(num18);
				num5 = num3 - num9 * Math.Cos(num18);
				num21 = (ushort)(num + 1);
				num = num21;
				DrawLine(streamWriter, num21, text, num19 + num2, num20 + num3, num19 + num4, num20 + num5);
				num2 = num4;
				...
				num2 = num4;
				num3 = num5;
				num4 = num2 - (num10 - num9 / 2.0) * Math.Sin(num18);
				num5 = num3 - (num10 - num9 / 2.0) * Math.Cos(num18);
				num21 = (ushort)(num + 1);
				num = num21;
				DrawLine(streamWriter, num21, text, num19 + num2, num20 + num3, num19 + num4, num20 + num5);
				num2 = num4;
				num3 = num5;
				num4 = num2 + (num26 - num15 - num10) * Math.Cos(num18);
				num5 = num3 - (num26 - num15 - num10) * Math.Sin(num18);
				num21 = (ushort)(num + 1);
				num = num21;
				DrawLine(streamWriter, num21, text, num19 + num2, num20 + num3, num19 + num4, num20 + num5);
				num2 = num4;
				num3 = num5;
				num4 = num2 + Math.Sqrt(2.0) * num10 * Math.Cos(num18 - Math.PI / 4.0);
				num5 = num3 - Math.Sqrt(2.0) * num10 * Math.Sin(num18 - Math.PI / 4.0);
				num21 = (ushort)(num + 1);
				num = num21;
				DrawLine(streamWriter, num21, text, num19 + num2, num20 + num3, num19 + num4, num20 + num5);
				num2 = num4;
				num3 = num5;
				num4 = num2 + num27 * Math.Sin(num18);
				num5 = num3 + num27 * Math.Cos(num18);
				num21 = (ushort)(num + 1);
				num = num21;
				DrawLine(streamWriter, num21, text, num19 + num2, num20 + num3, num19 + num4, num20 + num5);
			}
			double num28 = ((connection == "зварка") ? (L - 5) : L);
			num19 = 0.0;
			num20 = -200.0 - num28;
			double num29 = 0.0;
			double num30 = 0.0;
			...
			if (zhyrFiltr == "ні")
			{
				...
				num21 = (ushort)(num + 1);
				num = num21;
				DrawLine(streamWriter, num21, text, num19 + num2, num20 + num3 - num28, num19 + num4, num20 + num5 - num28);
				num2 = num4;
				num3 = num5;
				num4 = num2;
				num5 = num3 - num9;
				...
				num21 = (ushort)(num + 1);
				num = num21;
				DrawLine(streamWriter, num21, text, num19 + num2, num20 + num3 - num28, num19 + num4, num20 + num5 - num28 + 2.0 * num9);
				num2 = num4;
				num3 = num5;
				num4 = num2 + num9;
				num5 = num3;
				...
				num21 = (ushort)(num + 1);
				num = num21;
				DrawLine(streamWriter, num21, text, num19 + num2, num20 + num3 - num28 + 2.0 * num9, num19 + num4, num20 + num5 - num28 + 2.0 * num9);
				num2 = num4;
				num3 = num5;
				num4 = num2;
				num5 = num3 + num9;
				...
				num21 = (ushort)(num + 1);
				num = num21;
				DrawLine(streamWriter, num21, text, num19 + num2, num20 + num3 - num28 + num9, num19 + num4, num20 + num5 - num28 + num9);
				num2 = num4;
				num3 = num5;
				num4 = num2 + num31;
				num5 = num3;
				...
				num = num21;
				DrawLine(streamWriter, num21, text, num19 + num2, num20 + num3 - num28, num19 + num4, num20 + num5 - num28);
				num = DrawZaklepka_Top(streamWriter, num, text, connection, num2 + num19, num3 + num20, num4 + num19, num5 + num20, 1);
				num = DrawZaklepka_Top(streamWriter, num, text, connection, num2 + num19, num3 + num20 - num28, num4 + num19, num5 + num20 - num28, 0);
				num2 = num4;
				num3 = num5;
				num4 = num2;
				num5 = num3 - num9;
			...
			else
			{
				...
				{
					num = DrawZaklepka_Top_1(streamWriter, num, text, connection, num4 + num19, num5 + num20, num4 + num19, num5 - num28 + num20, 0, B - G + 10);
				}
				num2 = num4;
				num3 = num5;
				num4 = num2 + (double)B;
			...
			{
				double num34 = 100.0;
				double num35 = 50.0 + num31 + num31 + 2.0 * num9;
				double num36 = 16.0;
				num5 += num28;
				num2 = num4 - num35;
				num3 = ((zlyv == "так, трубка справа") ? (num5 - num28 + num34) : (num5 - num34));
				num21 = (ushort)(num + 1);
				num = num21;
				DrawCircle(streamWriter, num21, text, num19 + num2, num20 + num3, num36 / 2.0);
			}
			if (vyhid == "з виходом")
			{
				int num37 = d1;
				...
				num19 += num29 - num9 / 2.0;
				num20 += num30 - 0.5 * ((double)L - num28);
				if (vyhid1 == "круглий")
				{
					num2 = -g1;
					num3 = -f1;
					num21 = (ushort)(num + 1);
					num = num21;
					DrawCircle(streamWriter, num21, text, num19 + num2, num20 + num3, (double)d1 / 2.0);
				}
				...
				if (vyhid2 == "круглий")
				{
					...
					num21 = (ushort)(num + 1);
					num = num21;
					DrawCircle(streamWriter, num21, text, num19 + num2, num20 + num3, (double)d2 / 2.0);
				}
				...
				if (vyhid3 == "круглий")
				{
					...
					num21 = (ushort)(num + 1);
					num = num21;
					DrawCircle(streamWriter, num21, text, num19 + num2, num20 + num3, (double)d3 / 2.0);
				}
			...
			if (zhyrFiltr == "так" && G < B)
			{
				...
				num2 = num4;
				num3 = num5;
				num4 = num2 - ((double)(L - 5) - 2.0 * num53);
				num5 = num3;
				num21 = (ushort)(num + 1);
				num = num21;
				DrawLine(streamWriter, num21, text, num19 + num2, num20 + num3, num19 + num4, num20 + num5);
				num = DrawZaklepka_1(streamWriter, num, text, connection, num4 - 2.5 - num53 + num19, num5 + num20, num2 + 2.5 + num53 + num19, num3 + num20, 0);
			}
			if (zhyrFiltr == "так")
			{
				int num55 = 95;
	...
	public static void ZontPrystinnyyTyp2DrawImage(int L, int B, int H, int h, int number, string zontMaterial, string tovchynaMetaluZont, string connection, string zlyv, string fastening, string vyhid, string vyhid1, int d1, int a1, int b1, int p1, int f1, int g1, string typVyhid1, string profilType1, string vyhid2, int d2, int a2, int b2, int p2, int f2, int g2, string typVyhid2, string profilType2, string vyhid3, int d3, int a3, int b3, int p3, int f3, int g3, string typVyhid3, string profilType3, string zhyrFiltr, int G, string zhyrFiltrMaterial, string tovchynaMetaluFiltr, string typeFastening, string orderCode, string contragent, string filePath = null)
	{
		...
		//IL_527b: Expected O, but got Unknown
		...
		try
		{
			...
			int num17 = 12;
			int num18 = 10;
			Font val6 = new Font("Arial", (float)num17);
			Font val7 = new Font("Arial", (float)num18);
			...
			string text = "Зонт ЗВП-2 " + L + "х" + B + "х" + H;
			if (zhyrFiltr == "так")
			{
				text += " з ж/ф ";
			}
			...
			double num19 = (double)L * Math.Sin(num13);
			double num20 = 0.0;
			if (vyhid == "з виходом")
			{
				if (vyhid1 == "круглий" || vyhid1 == "прямокутний")
				{
					num20 = ((vyhid1 == "круглий") ? ((double)(f1 + d1 / 2) * Math.Sin(num13)) : ((double)(f1 + a1 / 2) * Math.Sin(num13)));
					num20 += (double)p1;
					if (num20 > num19)
					{
						num19 = num20;
				...
				{
					num20 = ((vyhid2 == "круглий") ? ((double)(f2 + d2 / 2) * Math.Sin(num13)) : ((double)(f2 + a2 / 2) * Math.Sin(num13)));
					num20 += (double)p2;
					if (num20 > num19)
					{
						num19 = num20;
				...
				{
					num20 = ((vyhid3 == "круглий") ? ((double)(f3 + d3 / 2) * Math.Sin(num13)) : ((double)(f3 + a3 / 2) * Math.Sin(num13)));
					num20 += (double)p3;
					if (num20 > num19)
					{
						num19 = num20;
			...
			double num21 = (double)(num2 / 3) / num19;
			if (num21 < num14)
			{
				num14 = num21;
			}
			int num22 = 10;
			int num23 = num5 + num17 + num22;
			int num24 = num23;
			if (num19 > (double)H + (double)L * Math.Sin(num13))
			{
				num23 += (int)((num19 - ((double)H + (double)L * Math.Sin(num13))) * num14);
			}
			double num25 = 100.0;
			double num26 = (double)L * num14;
			double num27 = (double)H * num14;
			double num28 = (double)B * num14;
			double num29 = (double)h * num14;
			double num30 = (double)G * num14;
			double num31 = num25 * num14;
			double num32 = num3;
			double num33 = (double)num23 + num26 * Math.Sin(num13);
			double num34 = num32 + num28;
			double num35 = num33;
			val2.DrawLine(val4, (float)num32, (float)num33, (float)num34, (float)num35);
			num34 = num32 + num26 * Math.Cos(num13);
			num35 = num23;
			val2.DrawLine(val4, (float)num32, (float)num33, (float)num34, (float)num35);
			num32 = num34;
			num33 = num35;
			num34 = num32 + num28;
			val2.DrawLine(val4, (float)num32, (float)num33, (float)num34, (float)num35);
			num32 = (double)num3 + num28;
			num33 = (double)num23 + num26 * Math.Sin(num13);
			num34 = num32 + num26 * Math.Cos(num13);
			num35 = num23;
			val2.DrawLine(val4, (float)num32, (float)num33, (float)num34, (float)num35);
			double num40;
			...
			if (vyhid == "з виходом")
			{
				if (vyhid1 == "круглий")
				{
					...
					num33 = (double)num23 + num26 * Math.Sin(num13) - (num36 - num38 / 2.0) * Math.Sin(num13);
				...
				else if (vyhid1 == "прямокутний")
				{
					...
					num33 = (double)num23 + num26 * Math.Sin(num13) - (num36 - num50 / 2.0) * Math.Sin(num13);
					num34 = num32 + num51;
					num35 = num33;
					val2.DrawLine(val4, (float)num32, (float)num33, (float)num34, (float)num35);
					num41 = num33 - num39;
				...
				if (vyhid2 == "круглий")
				{
					...
					num33 = (double)num23 + num26 * Math.Sin(num13) - (num56 - num58 / 2.0) * Math.Sin(num13);
				...
				else if (vyhid2 == "прямокутний")
				{
					...
					num33 = (double)num23 + num26 * Math.Sin(num13) - (num56 - num66 / 2.0) * Math.Sin(num13);
					num34 = num32 + num67;
					num35 = num33;
					val2.DrawLine(val4, (float)num32, (float)num33, (float)num34, (float)num35);
					num41 = num33 - num59;
				...
				if (vyhid3 == "круглий")
				{
					...
					num33 = (double)num23 + num26 * Math.Sin(num13) - (num71 - num73 / 2.0) * Math.Sin(num13);
				...
				else if (vyhid3 == "прямокутний")
				{
					...
					num33 = (double)num23 + num26 * Math.Sin(num13) - (num71 - num81 / 2.0) * Math.Sin(num13);
					num34 = num32 + num82;
					num35 = num33;
					val2.DrawLine(val4, (float)num32, (float)num33, (float)num34, (float)num35);
					num41 = num33 - num74;
			...
			val2.DrawLine(val4, (float)num32, (float)num33, (float)num34, (float)num35);
			num32 = num34;
			num34 = (double)num3 + num28;
			num35 = (double)num23 + num26 * Math.Sin(num13) + num29;
			val2.DrawLine(val4, (float)num32, (float)num33, (float)num34, (float)num35);
			num32 = num34;
			num33 = num35;
			num35 = num33 - num29;
			val2.DrawLine(val4, (float)num32, (float)num33, (float)num34, (float)num35);
			num34 = num32 + num26 * Math.Cos(num13);
			num35 = num33 - num26 * Math.Sin(num13);
			val2.DrawLine(val4, (float)num32, (float)num33, (float)num34, (float)num35);
			num32 = num34;
			num33 = num35;
			num35 = num33 - num29;
			...
			num32 = num3;
			num33 = (double)num23 + num26 * Math.Sin(num13) + num27;
			num34 = num32 - (double)num11;
			num35 = num33;
			val2.DrawLine(val3, (float)num32, (float)num33, (float)num34, (float)num35);
			num32 = num3 - num11 + 5;
			...
			val2.DrawLine(val3, (float)num32, (float)num33, (float)num34, (float)num35);
			num32 = num3;
			num33 = (double)num23 + num26 * Math.Sin(num13) + num27 + (double)num11 - 5.0;
			num34 = num32 + num31;
			num35 = num33;
			DrawRows(num32, num33, num34, num35, num14, val2, val3);
			num48 = (num32 + num34) / 2.0;
			num49 = num35 + (double)num18;
			val9.FormatFlags = (StringFormatFlags)1;
			val2.DrawString(num25.ToString(), val7, (Brush)(object)val8, (float)num48, (float)num49, val9);
			num32 = num3;
			num33 = (double)num23 + num26 * Math.Sin(num13) + num27;
			num34 = num32;
			num35 = num33 + (double)(2 * num11);
			val2.DrawLine(val3, (float)num32, (float)num33, (float)num34, (float)num35);
			num32 = (double)num3 + num28;
			num33 = (double)num23 + num26 * Math.Sin(num13) + num29;
			num34 = num32;
			val2.DrawLine(val3, (float)num32, (float)num33, (float)num34, (float)num35);
			num32 = num3;
			num33 = (double)num23 + num26 * Math.Sin(num13) + num27 + (double)(2 * num11) - 5.0;
			num34 = num32 + num28;
			num35 = num33;
			DrawRows(num32, num33, num34, num35, num14, val2, val3);
			num48 = (num32 + num34) / 2.0;
			...
			num32 = (double)num3 + num28 + num26 * Math.Cos(num13);
			num33 = (double)num23 + num29;
			num34 = num32;
			num35 = num33 + (double)num11;
			val2.DrawLine(val3, (float)num32, (float)num33, (float)num34, (float)num35);
			num32 = (double)num3 + num28;
			num33 = (double)num23 + num26 * Math.Sin(num13) + num29 + (double)num11 - 5.0;
			num34 = num32 + num26 * Math.Cos(num13);
			num35 = (double)num23 + num29 + (double)num11 - 5.0;
			DrawRows(num32, num33, num34, num35, num14, val2, val3);
			num48 = (num32 + num34) / 2.0;
			...
			num35 = num33;
			val2.DrawLine(val3, (float)num32, (float)num33, (float)num34, (float)num35);
			num32 = (double)num3 + num28 + num26 * Math.Cos(num13) + (double)num11 - 5.0;
			num33 = num23;
			num34 = num32;
			num35 = num33 + num29;
			DrawRows(num32, num33, num34, num35, num14, val2, val3);
			num48 = num32 + (double)num18 + 5.0;
			num49 = (num33 + num35) / 2.0;
			val9.FormatFlags = (StringFormatFlags)2;
			val2.DrawString(h.ToString(), val7, (Brush)(object)val8, (float)num48, (float)num49, val9);
			double num86 = Math.Atan(((double)H - (double)h) / ((double)B - num25));
			double num87 = Math.Min(num29 / 2.0, 20.0);
			num32 = (double)num3 + num28;
			num33 = (double)num23 + num26 * Math.Sin(num13) + num29 - num87;
			num40 = num32 - num87 * Math.Cos(num86);
			num41 = (double)num23 + num26 * Math.Sin(num13) + num29 + num87 * Math.Sin(num86);
			num34 = num32 - num87;
			...
			num86 = Math.Round(num86 * 180.0 / Math.PI, MidpointRounding.AwayFromZero) + 90.0;
			val9.FormatFlags = (StringFormatFlags)1;
			val2.DrawString(num86 + "°", val7, (Brush)(object)val8, (float)(num34 - 10.0), (float)num35 - 5f, val9);
			val9.FormatFlags = (StringFormatFlags)2;
			if (zhyrFiltr == "так")
			{
				num25 = 100.0;
				...
				double num96 = 20.0;
				num31 = num25 * num14;
				double num97 = num88 * num14;
				double num98 = num90 * num14;
				double num99 = num89 * num14;
				double num100 = num91 * num14;
				double num101 = num92 * num14;
				double num102 = num93 * num14;
				double num103 = num94 * num14;
				double num104 = num95 * num14;
				double num105 = num96 * num14;
				num32 = num3;
				num33 = (double)num23 + num26 * Math.Sin(num13) + num27;
				num34 = num32 + num31;
				num35 = num33;
				...
				if (typeUpperStrip == 2)
				{
					num32 = (double)num3 + num30;
					num33 = (double)num23 + num26 * Math.Sin(num13);
					num34 = num32;
					num35 = num33 + (double)num11;
					val2.DrawLine(val3, (float)num32, (float)num33, (float)num34, (float)num35);
					num32 = num3;
					num33 = (double)num23 + num26 * Math.Sin(num13) + (double)num11 - 5.0;
					num35 -= 5.0;
					DrawRows(num32, num33, num34, num35, num14, val2, val3);
					num48 = (num32 + num34) / 2.0;
					num49 = num35 + (double)num18 + 3.0;
					val9.FormatFlags = (StringFormatFlags)1;
					...
					val2.DrawLine(val5, (float)num32, (float)num33, (float)num34, (float)num35);
					num32 = (double)num3 + num31;
					num33 = (double)num23 + num26 * Math.Sin(num13) + num27 - num97;
					num34 = (double)num3 + num30;
					num35 = (double)num23 + num26 * Math.Sin(num13) + num100;
					double num106 = 1E-05;
					double num107 = Math.Atan((num33 - num35) / (num34 - num32));
					double num108 = Math.Atan((num33 - num35 + num102) / (num34 - num32 - num102));
					num16 = 0.0;
					while (num108 - num107 > num106)
					{
						num16 = (num107 + num108) / 2.0;
						double num109 = Math.Tan(num107) - (num33 - num35 + num102 * Math.Cos(num107)) / (num34 - num32 - num102 * Math.Sin(num107));
						double num110 = Math.Tan(num16) - (num33 - num35 + num102 * Math.Cos(num16)) / (num34 - num32 - num102 * Math.Sin(num16));
						if (num109 * num110 < 0.0)
						{
							num108 = num16;
						}
						else
					...
					num34 = num32 - num99 * Math.Sin(num16);
					num35 = num33 - num99 * Math.Cos(num16);
					val2.DrawLine(val5, (float)num32, (float)num33, (float)num34, (float)num35);
					num32 = (double)num3 + num30;
					num33 = (double)num23 + num26 * Math.Sin(num13) + num100;
					num34 = num32 - num101 * Math.Cos(num16);
					num35 = num33 + num101 * Math.Sin(num16);
					val2.DrawLine(val5, (float)num32, (float)num33, (float)num34, (float)num35);
					num32 = num34;
					num33 = num35;
					num34 = num32 - num102 * Math.Sin(num16);
					num35 = num33 - num102 * Math.Cos(num16);
					val2.DrawLine(val5, (float)num32, (float)num33, (float)num34, (float)num35);
					double num111 = 40.0;
					double num112 = (double)G - num25 - num93 * Math.Sin(num16);
					double num113 = (double)H - num88 - num91 + num93 * Math.Cos(num16);
					l = (int)Math.Round(Math.Sqrt(num112 * num112 + num113 * num113) - num111);
				}
				else
				{
					num32 = (double)num3 + num31;
					...
					num35 = (double)num23 + num26 * Math.Sin(num13) + num29;
					double num114 = 1E-05;
					double num115 = Math.Atan((num33 - num35) / (num34 - num32));
					double num116 = Math.Atan((num33 - num35 + num102) / (num34 - num32 - num102));
					num16 = 0.0;
					while (num116 - num115 > num114)
					{
						num16 = (num115 + num116) / 2.0;
						double num117 = Math.Tan(num115) - (num33 - num35 + num102 * Math.Cos(num115)) / (num34 - num32 - num102 * Math.Sin(num115));
						double num118 = Math.Tan(num16) - (num33 - num35 + num102 * Math.Cos(num16)) / (num34 - num32 - num102 * Math.Sin(num16));
						if (num117 * num118 < 0.0)
						{
							num116 = num16;
						}
						else
					...
					val2.DrawLine(val5, (float)num32, (float)num33, (float)num34, (float)num35);
					double num119 = 40.0;
					double num120 = (double)B - num25 - num93 * Math.Sin(num16);
					double num121 = (double)H - num88 - num91 + num93 * Math.Cos(num16);
					l = (int)Math.Round(Math.Sqrt(num120 * num120 + num121 * num121) - num119);
				}
				betaGradus = 90 - (int)Math.Round(num16 * 180.0 / Math.PI);
				double num122 = 6.0;
				num32 = (double)num3 + num31 + num122 * Math.Cos(num16);
				num33 = (double)num23 + num26 * Math.Sin(num13) + num27 - num97 - num122 * Math.Sin(num16);
				num34 = num32 - num103 * Math.Sin(num16);
				num35 = num33 - num103 * Math.Cos(num16);
				val2.DrawLine(val5, (float)num32, (float)num33, (float)num34, (float)num35);
				num32 = (double)num3 + num31 + num122 * Math.Cos(num16);
				num33 = (double)num23 + num26 * Math.Sin(num13) + num27 - num97 - num122 * Math.Sin(num16);
				num34 = num32 + num104 * Math.Cos(num16);
				num35 = num33 - num104 * Math.Sin(num16);
				val2.DrawLine(val5, (float)num32, (float)num33, (float)num34, (float)num35);
				num32 = (double)num3 + num31 + num122 * Math.Cos(num16) - num103 * Math.Sin(num16);
				num33 = (double)num23 + num26 * Math.Sin(num13) + num27 - num97 - num122 * Math.Sin(num16) - num103 * Math.Cos(num16);
				num34 = num32 + num105 * Math.Cos(num16);
				num35 = num33 - num105 * Math.Sin(num16);
				val2.DrawLine(val5, (float)num32, (float)num33, (float)num34, (float)num35);
				double num123 = (double)l * num14 - num122;
				double num124 = 4.0;
				double num125 = num94 * num14 - 2.0 * num124;
				num32 = (double)num3 + num31 + num122 * Math.Cos(num16) - num124 * Math.Sin(num16) + num122 * Math.Cos(num16);
				num33 = (double)num23 + num26 * Math.Sin(num13) + num27 - num97 - num122 * Math.Sin(num16) - num124 * Math.Cos(num16) - num122 * Math.Sin(num16);
				num34 = num32 - num125 * Math.Sin(num16);
				num35 = num33 - num125 * Math.Cos(num16);
				val2.DrawLine(val4, (float)num32, (float)num33, (float)num34, (float)num35);
				num32 = (double)num3 + num31 + num122 * Math.Cos(num16) - num124 * Math.Sin(num16) + num122 * Math.Cos(num16);
				num33 = (double)num23 + num26 * Math.Sin(num13) + num27 - num97 - num122 * Math.Sin(num16) - num124 * Math.Cos(num16) - num122 * Math.Sin(num16);
				num34 = num32 + num123 * Math.Cos(num16);
				num35 = num33 - num123 * Math.Sin(num16);
				val2.DrawLine(val4, (float)num32, (float)num33, (float)num34, (float)num35);
				num32 = (double)num3 + num31 + num122 * Math.Cos(num16) - num124 * Math.Sin(num16) + num122 * Math.Cos(num16) - num125 * Math.Sin(num16);
				num33 = (double)num23 + num26 * Math.Sin(num13) + num27 - num97 - num122 * Math.Sin(num16) - num124 * Math.Cos(num16) - num122 * Math.Sin(num16) - num125 * Math.Cos(num16);
				num34 = num32 + num123 * Math.Cos(num16);
				num35 = num33 - num123 * Math.Sin(num16);
				val2.DrawLine(val4, (float)num32, (float)num33, (float)num34, (float)num35);
				num32 = (double)num3 + num31 + num122 * Math.Cos(num16) - num124 * Math.Sin(num16) + num122 * Math.Cos(num16) + num123 * Math.Cos(num16);
				num33 = (double)num23 + num26 * Math.Sin(num13) + num27 - num97 - num122 * Math.Sin(num16) - num124 * Math.Cos(num16) - num122 * Math.Sin(num16) - num123 * Math.Sin(num16);
				num34 = (double)num3 + num31 + num122 * Math.Cos(num16) - num124 * Math.Sin(num16) + num122 * Math.Cos(num16) - num125 * Math.Sin(num16) + num123 * Math.Cos(num16);
				num35 = (double)num23 + num26 * Math.Sin(num13) + num27 - num97 - num122 * Math.Sin(num16) - num124 * Math.Cos(num16) - num122 * Math.Sin(num16) - num125 * Math.Cos(num16) - num123 * Math.Sin(num16);
				val2.DrawLine(val4, (float)num32, (float)num33, (float)num34, (float)num35);
				double num126 = 1.5;
				double num127 = 0.0;
				double num128 = 0.0;
				...
				num104 = num95 * num126;
				num105 = num96 * num126;
				num30 = (double)G * num126;
				num27 = (double)H * num126;
				num29 = (double)h * num126;
				num28 = (double)B * num126;
				num129 = num - num4;
				num130 = (double)num24 + num19 * num14;
				num127 = (double)(num - num4) - num31;
				num128 = num130 + num101 + num97 + num98;
				num128 += ((typeUpperStrip == 2) ? num100 : num29);
				num32 = num127;
				num33 = num128;
				num34 = num32 + num31;
				num35 = num33;
				...
				num35 = num134 - 5.0;
				DrawRows(num32, num33, num34, num35, num14, val2, val3);
				num48 = (num131 + num133) / 2.0;
				num49 = num132 + (double)num18;
				val9.FormatFlags = (StringFormatFlags)1;
				val2.DrawString(num25.ToString(), val7, (Brush)(object)val8, (float)num48, (float)num49, val9);
				num32 = num127 + num31;
				num33 = num128;
				...
				num48 = num32 - (double)num18 - 3.0;
				num49 = (num33 + num35) / 2.0;
				val9.FormatFlags = (StringFormatFlags)1;
				val2.DrawString(num88.ToString(), val7, (Brush)(object)val8, (float)num48, (float)num49, val9);
				if (typeUpperStrip == 2)
				{
					num32 = num129;
					num33 = num130;
					...
					val2.DrawLine(val3, (float)num32, (float)num33, (float)num34, (float)num35);
					num32 = num129;
					num33 = num130 - (double)num12 + 5.0;
					num34 = num32 - num98;
					num35 = num33;
					DrawRows(num34, num35, num32, num33, num14, val2, val3);
					num48 = (num32 + num34) / 2.0;
					num49 = num33 - (double)num18 - 3.0;
					val9.FormatFlags = (StringFormatFlags)1;
					val2.DrawString(num90.ToString(), val7, (Brush)(object)val8, (float)num48, (float)num49, val9);
				}
				num32 = num129;
				num33 = num130;
				num34 = num32;
				...
				if (typeUpperStrip == 2)
				{
					val2.DrawString(num91.ToString(), val7, (Brush)(object)val8, (float)num48, (float)num49, val9);
				}
				else
				{
					val2.DrawString("h", val7, (Brush)(object)val8, (float)num48, (float)num49, val9);
				}
				num32 = num127 + num31;
				num33 = num128 - num97;
				num34 = num32 - num99 * Math.Sin(num16);
				num35 = num33 - num99 * Math.Cos(num16);
				val2.DrawLine(val5, (float)num32, (float)num33, (float)num34, (float)num35);
				num34 = num32 + (double)num12 * Math.Cos(num16);
				num35 = num33 - (double)num12 * Math.Sin(num16);
				val2.DrawLine(val3, (float)num32, (float)num33, (float)num34, (float)num35);
				num32 -= num98 * Math.Sin(num16);
				num33 -= num98 * Math.Cos(num16);
				num34 = num32 + (double)num12 * Math.Cos(num16);
				num35 = num33 - (double)num12 * Math.Sin(num16);
				val2.DrawLine(val3, (float)num32, (float)num33, (float)num34, (float)num35);
				num32 = num127 + num31 + (double)(num12 - 5) * Math.Cos(num16);
				num33 = num128 - num97 - (double)(num12 - 5) * Math.Sin(num16);
				num34 -= 5.0 * Math.Cos(num16);
				num35 += 5.0 * Math.Sin(num16);
				DrawRows(num34, num35, num32, num33, num14, val2, val3);
				num48 = (num32 + num34) / 2.0 + (double)num18;
				num49 = (num33 + num35) / 2.0 - (double)(num18 / 2);
				val9.FormatFlags = (StringFormatFlags)1;
				val2.DrawString(num89.ToString(), val7, (Brush)(object)val8, (float)num48, (float)num49, val9);
				num32 = num127 + num31;
				num33 = num128 - num97;
				num34 = num32 + num98 * Math.Sin(num16);
				num35 = num33 + num98 * Math.Cos(num16);
				val2.DrawLine(val3, (float)num32, (float)num33, (float)num34, (float)num35);
				double num135 = 3.0 * num99 * Math.Sin(num16) / 4.0;
				double num136 = 3.0 * num99 * Math.Cos(num16) / 4.0;
				num32 = num127 + num31;
				num33 = num128 - num97 + num136;
				num40 = num32 + num135;
				num41 = num33;
				...
				string text2 = Math.Round(num16 * 180.0 / Math.PI) + "°";
				val2.DrawString(text2, val7, (Brush)(object)val8, (float)(num34 + 3.0), (float)(num35 + (double)num18), val9);
				num32 = num129;
				num33 = num130 + num100;
				num34 = num32 - num101 * Math.Cos(num16);
				num35 = num33 + num101 * Math.Sin(num16);
				val2.DrawLine(val5, (float)num32, (float)num33, (float)num34, (float)num35);
				num34 = num32 - (double)num12 * Math.Sin(num16);
				num35 = num33 - (double)num12 * Math.Cos(num16);
				num131 = num34;
				num132 = num35;
				val2.DrawLine(val3, (float)num32, (float)num33, (float)num34, (float)num35);
				num32 = num129 - num101 * Math.Cos(num16);
				num33 = num130 + num100 + num101 * Math.Sin(num16);
				num34 = num32 - (double)num12 * Math.Sin(num16);
				num35 = num33 - (double)num12 * Math.Cos(num16);
				val2.DrawLine(val3, (float)num32, (float)num33, (float)num34, (float)num35);
				num32 = num131 + 5.0 * Math.Sin(num16);
				num33 = num132 + 5.0 * Math.Cos(num16);
				num34 += 5.0 * Math.Sin(num16);
				num35 += 5.0 * Math.Cos(num16);
				DrawRows(num34, num35, num32, num33, num14, val2, val3);
				num48 = (num32 + num34) / 2.0 - (double)num18;
				num49 = (num33 + num35) / 2.0 - (double)(num18 / 2);
				val9.FormatFlags = (StringFormatFlags)1;
				val2.DrawString(num92.ToString(), val7, (Brush)(object)val8, (float)num48, (float)num49, val9);
				num32 = num129;
				num33 = num130 + num100;
				num34 = num32;
				num35 = num33 + num101 * Math.Sin(num16);
				val2.DrawLine(val3, (float)num32, (float)num33, (float)num34, (float)num35);
				num135 = 3.0 * num101 * Math.Cos(num16) / 8.0;
				num136 = 3.0 * num101 * Math.Sin(num16) / 8.0;
				num32 = num129;
				num33 = num130 + num100 + num136;
				num40 = num32 - num135;
				num41 = num33;
				num34 = (num32 + num40) / 2.0;
				num35 = (num33 + num41) / 2.0 + 5.0;
				val2.DrawBezier(val3, (float)num32, (float)num33, (float)num34, (float)num35, (float)num40, (float)num41, (float)num40, (float)num41);
				text2 = Math.Round((Math.PI / 2.0 - num16) * 180.0 / Math.PI) + "°";
				val2.DrawString(text2, val7, (Brush)(object)val8, (float)(num34 + 3.0), (float)(num35 + (double)num18), val9);
				num32 = num129 - num101 * Math.Cos(num16);
				num33 = num130 + num100 + num101 * Math.Sin(num16);
				num34 = num32 - num102 * Math.Sin(num16);
				...
				num132 = num35;
				val2.DrawLine(val3, (float)num32, (float)num33, (float)num34, (float)num35);
				num32 -= num102 * Math.Sin(num16);
				num33 -= num102 * Math.Cos(num16);
				num34 = num32 - (double)num12 * Math.Cos(num16);
				num35 = num33 + (double)num12 * Math.Sin(num16);
				val2.DrawLine(val3, (float)num32, (float)num33, (float)num34, (float)num35);
				num32 = num131 + 5.0 * Math.Cos(num16);
				num33 = num132 - 5.0 * Math.Sin(num16);
				num34 += 5.0 * Math.Cos(num16);
				num35 -= 5.0 * Math.Sin(num16);
				DrawRows(num32, num33, num34, num35, num14, val2, val3);
				num48 = (num32 + num34) / 2.0 - (double)num18;
				num49 = (num33 + num35) / 2.0 + (double)(num18 / 2);
				val9.FormatFlags = (StringFormatFlags)1;
				val2.DrawString(num93.ToString(), val7, (Brush)(object)val8, (float)num48, (float)num49, val9);
				num128 = num130 + num104;
				num32 = num127;
				num33 = num128;
				num34 = num32 + num103;
				num35 = num33;
			...
			if (vyhid == "з виходом")
			{
				...
				num8 += num12;
				if (num15 * (double)B + (double)(3 * num12) + (double)num137 > (double)num2 / 3.0)
				{
					num15 = ((double)num2 / 3.0 - (double)(3 * num12) - (double)num137) / (double)B;
				}
				num26 = (double)L * num15;
				num28 = (double)B * num15;
				...
				val2.DrawLine(val4, (float)num32, (float)num33, (float)num34, (float)num35);
				num32 = num7;
				num33 = (double)num8 + num28;
				num34 = num32 + num26;
				num35 = num33;
				val2.DrawLine(val4, (float)num32, (float)num33, (float)num34, (float)num35);
				num32 = (double)num7 + num26;
				num33 = (double)num8 + num28;
				num34 = num32 + (double)num11;
				num35 = num33;
				double num133 = num34;
				...
				val2.DrawLine(val3, (float)num32, (float)num33, (float)num34, (float)num35);
				num48 = (num131 + num133) / 2.0;
				num49 = (num132 + num134) / 2.0 + (double)num18;
				val9.FormatFlags = (StringFormatFlags)1;
				val2.DrawString(L.ToString(), val7, (Brush)(object)val8, (float)num48, (float)num49, val9);
				if (vyhid1 == "круглий")
				{
				...
				else if (vyhid1 == "прямокутний")
				{
					...
					DrawRows(num34, num35, num32, num33, num15, val2, val3);
					num48 = num32 + (double)num18;
					num49 = ((vyhid2 == "прямокутний") ? (num35 + 10.0) : ((num33 + num35) / 2.0));
					val9.FormatFlags = (StringFormatFlags)2;
					val2.DrawString(g1.ToString(), val7, (Brush)(object)val8, (float)num48, (float)num49, val9);
			...
			num9 = num3;
			num10 = num24 + (int)(num19 * num14) + 70;
			if (vyhid == "з виходом")
			{
				num10 += num2 / 3 + 20;
			}
			int num138 = 10;
			int num139 = 0;
			Font val10 = new Font("Arial", (float)num138);
			...
			if (zhyrFiltr == "так")
			{
				for (int i = 0; i < nFiltr; i++)
				{
					...
					{
					case 0:
						val2.DrawString("Ширина першого жирфільтра: " + kFiltr[0] + "мм", val10, (Brush)(object)val8, (float)num9, (float)(num10 + num139), val11);
						break;
					case 1:
						val2.DrawString("Ширина другого жирфільтра: " + kFiltr[1] + "мм", val10, (Brush)(object)val8, (float)num9, (float)(num10 + num139), val11);
						break;
					case 2:
						val2.DrawString("Ширина третього жирфільтра: " + kFiltr[2] + "мм", val10, (Brush)(object)val8, (float)num9, (float)(num10 + num139), val11);
						break;
					}
					num139 += num138 + 8;
					if (num10 + num139 > num2 - num6)
					{
						num9 = num3 + num / 2;
						num139 = 0;
					}
				...
				if (nFiltr == 1)
				{
					val2.DrawString("Довжина жирфільтра: " + l + "мм", val10, (Brush)(object)val8, (float)num9, (float)(num10 + num139), val11);
				}
				else
				{
					val2.DrawString("Довжина жирфільтрів: " + l + "мм", val10, (Brush)(object)val8, (float)num9, (float)(num10 + num139), val11);
				}
				num139 += num138 + 8;
				if (num10 + num139 > num2 - num6)
				{
			...
			val2.DrawString("Матеріал зонта: " + zontMaterial, val10, (Brush)(object)val8, (float)num9, (float)(num10 + num139), val11);
			num139 += num138 + 8;
			if (num10 + num139 > num2 - num6)
			{
				num9 = num3 + num / 2;
			...
			val2.DrawString("Товщина металу зонта: " + tovchynaMetaluZont + "мм", val10, (Brush)(object)val8, (float)num9, (float)(num10 + num139), val11);
			num139 += num138 + 8;
			if (num10 + num139 > num2 - num6)
			{
				num9 = num3 + num / 2;
			...
			val2.DrawString("З'єднання: " + connection, val10, (Brush)(object)val8, (float)num9, (float)(num10 + num139), val11);
			num139 += num138 + 8;
			if (num10 + num139 > num2 - num6)
			{
				num9 = num3 + num / 2;
			...
			val2.DrawString("Трубка зливу 1/2': " + zlyv, val10, (Brush)(object)val8, (float)num9, (float)(num10 + num139), val11);
			num139 += num138 + 8;
			if (num10 + num139 > num2 - num6)
			{
				num9 = num3 + num / 2;
			...
			val2.DrawString("Кріплення: " + fastening, val10, (Brush)(object)val8, (float)num9, (float)(num10 + num139), val11);
			if (fastening == "так")
			{
				num139 += num138 + 8;
				if (num10 + num139 > num2 - num6)
				...
				val2.DrawString("Тип кріплення: " + typeFastening, val10, (Brush)(object)val8, (float)num9, (float)(num10 + num139), val11);
			}
			if (vyhid == "з виходом")
			{
				if (vyhid1 == "круглий" || vyhid1 == "прямокутний")
				{
					...
					val2.DrawString("Тип виходу 1: " + typVyhid1, val10, (Brush)(object)val8, (float)num9, (float)(num10 + num139), val11);
					if (typVyhid1 == "фланець")
					{
						...
						val2.DrawString("Тип профілю для виходу 1: " + profilType1, val10, (Brush)(object)val8, (float)num9, (float)(num10 + num139), val11);
					}
				}
				if (vyhid2 == "круглий" || vyhid2 == "прямокутний")
				{
					...
					val2.DrawString("Тип виходу 2: " + typVyhid2, val10, (Brush)(object)val8, (float)num9, (float)(num10 + num139), val11);
					if (typVyhid2 == "фланець")
					{
						...
						val2.DrawString("Тип профілю для виходу 2: " + profilType2, val10, (Brush)(object)val8, (float)num9, (float)(num10 + num139), val11);
					}
				}
				if (vyhid3 == "круглий" || vyhid3 == "прямокутний")
				{
					...
					val2.DrawString("Тип виходу 3: " + typVyhid3, val10, (Brush)(object)val8, (float)num9, (float)(num10 + num139), val11);
					if (typVyhid3 == "фланець")
					{
						...
						val2.DrawString("Тип профілю для виходу 3: " + profilType3, val10, (Brush)(object)val8, (float)num9, (float)(num10 + num139), val11);
					}
				}
			}
			if (zhyrFiltr == "так")
			{
				...
				val2.DrawString("Матеріал жирфільтра: " + zhyrFiltrMaterial, val10, (Brush)(object)val8, (float)num9, (float)(num10 + num139), val11);
				num139 += num138 + 8;
				if (num10 + num139 > num2 - num6)
				{
					num9 = num3 + num / 2;
				...
				val2.DrawString("Товщина металу жирфільтра: " + tovchynaMetaluFiltr + "мм", val10, (Brush)(object)val8, (float)num9, (float)(num10 + num139), val11);
			}
		}
		finally
		{
	...
	public static double VolumeZontPrystinnyyTyp2(int L, int B, int H, int p1, int p2, int p3)
	{
		int num = ((p1 > p2) ? p1 : p2);
		if (p3 > num)
		{
