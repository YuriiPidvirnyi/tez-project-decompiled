...
public class Product_ZaglushkaZK : IProduct
{
	...
	public string TypMaterialFlanets { get; set; }

	public string Vidbortovka { get; set; }

	public string AisiType { get; set; }

	public Product_ZaglushkaZK()
	{
	}

	public Product_ZaglushkaZK(JObject jObj)
	{
		...
		TypMaterialFlanets = jObj.GetValue("TypMaterialFlanets").ToString();
