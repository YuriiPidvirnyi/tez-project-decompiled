...
public class Product_DeflektorDK : IProduct
{
	...
	public string TypProfil { get; set; }

	public Product_DeflektorDK()
	{
	}

	public Product_DeflektorDK(JObject jObj)
	{
		...
		TypeOf = jObj.GetValue("TypeOf").ToString();
		TypProfil = jObj.GetValue("TypProfil")?.ToString();
	}
}
