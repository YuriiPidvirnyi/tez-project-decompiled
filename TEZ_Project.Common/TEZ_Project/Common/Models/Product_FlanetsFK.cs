...
public class Product_FlanetsFK : IProduct
{
	...
	public string TypMaterial { get; set; }

	public Product_FlanetsFK()
	{
	}

	public Product_FlanetsFK(JObject jObj)
	{
		...
		TypMaterial = jObj.GetValue("TypMaterial").ToString();
	}
}
