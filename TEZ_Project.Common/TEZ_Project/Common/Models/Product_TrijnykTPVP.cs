...
public class Product_TrijnykTPVP : IProduct
{
	...
	public string TypeTPVPenter { get; set; }

	public string TypeTPVPleft { get; set; }

	public string TypeTPVPright { get; set; }
	...
	public Product_TrijnykTPVP()
	{
	}

	public Product_TrijnykTPVP(JObject jObj)
	{
		...
		TypeTPVPenter = jObj.GetValue("TypeTPVPenter").ToString();
		TypeTPVPleft = jObj.GetValue("TypeTPVPleft").ToString();
		TypeTPVPright = jObj.GetValue("TypeTPVPright").ToString();
