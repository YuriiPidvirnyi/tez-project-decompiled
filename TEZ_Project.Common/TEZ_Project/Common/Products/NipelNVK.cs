...
public static class NipelNVK
{
	...
	public static double[] MaterialNipelNVK(int D, int markaStali, double tovchynaMetalu, int number, string aisiType = "430")
	{
		...
		array[0] = array[0] * 3.14 * (double)D / 1000000.0;
		array[0] *= 1.05;
	...
	public static double PriceNipelNVK(int D, int markaStali, double tovchynaMetalu)
	{
		double num = 0.0;
		double num2 = 1.0;
		materialSpendingCommercialOffer = ((D <= 630) ? 100 : 137);
		materialSpendingCommercialOffer = materialSpendingCommercialOffer * 3.14 * (double)D / 1000000.0;
		switch (markaStali)
		{
		case 1:
		{
	...
	public static double[] FormPriceNipelNVK()
	{
		...
		for (int i = 0; i < array.Length; i++)
		{
			...
			num = num * 3.14 * (double)array2[i] / 1000000.0;
			if (array2[i] <= 400)
			{
				array[i] = 287.5;
			}
	...
	public static double VolumeNipelNVK(int D)
	{
