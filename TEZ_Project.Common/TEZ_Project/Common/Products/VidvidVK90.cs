...
public static class VidvidVK90
{
	...
	public static double[,] MaterialVidvidVK(int D, double R, int K, int K1, int markaStali, double tovchynaMetalu, int typVK, int typProfil, int number, string aisiType = "430")
	{
		...
		double num9 = ((D < 400) ? 0.1 : ((D >= 560) ? ((D < 900) ? 0.17400000000000002 : 0.20400000000000001) : 0.15000000000000002));
		if (R == 1.0)
		{
			double num10 = ((D >= 1000) ? 115.0 : ((D >= 710) ? 100.0 : ((D < 400) ? ((double)((D >= 250) ? 55 : 36)) : 75.0)));
			array[num3, 0] = (Math.PI * (double)D / 1000.0 + num8) * (Math.PI / 2.0 * (double)D / 1000.0 + 2.0 * (num10 + 15.7 + 5.0 + 15.0) / 1000.0 + num9);
		}
		else
		{
			double num10 = ((D < 710) ? 40 : 60);
			array[num3, 0] = (Math.PI * (double)D / 1000.0 + num8) * (Math.PI / 2.0 * R * (double)D / 1000.0 + 2.0 * (num10 + 25.0) / 1000.0 + num9);
		}
	...
	public static double PriceVidvidVK(int D, double R, int K, int K1, int markaStali, double tovchynaMetalu, int typVK, int typProfil)
	{
		double num = 1.0;
		materialSpendingCommercialOffer = Math.PI * (double)D / 1000.0 * Math.PI / 2.0 * (double)D * R / 1000.0 + Math.PI * (double)D / 1000.0 * 50.0 / 1000.0 * 2.0;
		...
		if (typVK == 8 || typVK == 9 || typVK == 10)
		{
			num6 += 1.8 * Consts2.sitka25x25.Price * (double)D * (double)D / 1000000.0;
		}
		...
		if (typVK == 5 || typVK == 6 || typVK == 10)
		{
			...
			num6 += ((typVK == 5) ? FlanetsKruglyj.priceProduct1 : (2.0 * FlanetsKruglyj.priceProduct1));
		}
		tovchynaMetaluCommercialOffer = tovchynaMetalu;
		return num6;
	}

	public static double[] FormPriceVidvidVK()
	{
		double num = 1.0;
		...
		for (int i = 0; i < array.Length; i++)
		{
			...
			{
				array[i] = ((array2[i] <= 800) ? 406.0 : 520.0);
			}
			array[i] = Math.PI * (double)array2[i] / 1000.0 * Math.PI / 2.0 * (double)array2[i] * num / 1000.0 + Math.PI * (double)array2[i] / 1000.0 * 50.0 / 1000.0 * 2.0 * array[i];
		}
		return array;
	}

	public static double VolumeVidvidVK(int D, double R, int K, int K1)
	{
		return Math.Round((R * (double)D + (double)D / 2.0 + (double)K) * (R * (double)D + (double)D / 2.0 + (double)K1) * (double)D / 1000000.0) / 1000.0;
	}
}
