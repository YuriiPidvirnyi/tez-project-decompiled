...
public class ZontPrystinnyyTyp31
{
	...
	public static double[,] MaterialZontPrystinnyyTyp31(int L, int B, int H, int h, int a, int b, int p, double c, int number, string markaStaliZont, string tovchynaMetaluZont, string connection, string zlyv, string fastening, string typeFastening, string zhyrFiltr, string markaStaliFiltr, string tovchynaMetaluFiltr, string implementation1)
	{
		...
		double num9 = Math.Sqrt(Math.Pow(c, 2.0) + Math.Pow(H - h, 2.0));
		double num10 = Math.Sqrt(Math.Pow(c, 2.0) + Math.Pow(B - b, 2.0) + Math.Pow(H - h, 2.0));
		double num11 = Math.Sqrt(Math.Pow((double)(L - a) - c, 2.0) + Math.Pow(B - b, 2.0) + Math.Pow(H - h, 2.0));
		double num12 = Math.Sqrt(Math.Pow((double)(L - a) - c, 2.0) + Math.Pow(H - h, 2.0));
		double num13 = 1.0;
		double num14 = 10.0;
		double num15 = 20.0;
		double num16 = ((connection == "зварка") ? 12 : 15);
		double num17 = Math.Sqrt(Math.Pow(num9, 2.0) - Math.Pow(c, 2.0));
		num17 += num14 + num15 + (double)p + (double)h + 2.0 * num13;
		double num18 = L;
		num5 = num18 * num17;
		if (num17 > 2500.0)
		{
		...
		num17 = Math.Sqrt(Math.Pow(num10, 2.0) - Math.Pow(c, 2.0));
		num17 += num14 + num15 + (double)p + (double)h + 2.0 * num13;
		num18 = L;
		num5 += num18 * num17;
		if (num17 > 2500.0)
		...
		num17 = num9;
		num17 += num14 + num15 + (double)p + (double)h;
		num18 = (double)B + 2.0 * num16;
		num5 += num18 * num17;
		if (num17 > 2500.0)
		{
			num5 += 40.0 * num18;
		...
		if (zhyrFiltr == "так")
		{
			if (implementation1 == "ж/ф внизу зонта (2 ряди)")
			{
				double num19 = 54.5;
				double num20 = 15.0;
				num7 = (num19 + num20) * (double)(L - 10);
				num19 = 24.5;
				num20 = 109.0;
				num7 += (num20 + 2.0 * (num19 + num13)) * (double)(L - 5);
			}
			else
			{
				double num21 = 9.5;
				...
				double num24 = 20.0;
				double num25 = 70.0;
				num7 = (num21 + num22 + num23 + num24 + 2.0 * num13) * ((double)ZontPrystinnyyTyp31.l + num25);
				double num26 = 20.0;
				double num27 = 60.0;
				double num28 = 15.0;
				double num29 = 35.0;
				num7 += (num26 + num27 + 2.0 * num28 + num29) * (kk + 2.0 * num28);
			}
		}
		num6 = (double)p * 2.0 * (double)(a + b);
		...
		{
			int num30 = 50;
			int num31 = 4 * ((int)Math.Round(((double)h - 22.0 - 28.0) / (double)num30, MidpointRounding.AwayFromZero) + 1);
			num31 += (int)Math.Round((num9 - 22.0 - 28.0) / (double)num30, MidpointRounding.AwayFromZero) + 1;
			num31 += (int)Math.Round((num10 - 22.0 - 28.0) / (double)num30, MidpointRounding.AwayFromZero) + 1;
			num31 += (int)Math.Round((num11 - 22.0 - 28.0) / (double)num30, MidpointRounding.AwayFromZero) + 1;
			num31 += (int)Math.Round((num12 - 22.0 - 28.0) / (double)num30, MidpointRounding.AwayFromZero) + 1;
			num31 += ((implementation1 == "ж/ф внизу зонта (2 ряди)") ? 4 : 11);
			num++;
		...
		if (zhyrFiltr == "так")
		{
			...
			{
				array2 = FiltrZh.MaterialFiltrZh(kFiltr[j], ZontPrystinnyyTyp31.l, markaStaliFiltr, tovchynaMetaluFiltr, number);
	...
	public static void ZontPrystinnyyTyp31DrawDxf(int L, int B, int H, int h, int a, int b, int p, double c, string connection, string zlyv, string zhyrFiltr, string implementation1, string filePath)
	{
		ushort num = 566;
		string text = "0";
		double num2 = 0.0;
		...
		try
		{
			...
			double num16 = Math.Sqrt(Math.Pow(c, 2.0) + Math.Pow(H - h, 2.0));
			double num17 = Math.Sqrt(Math.Pow(c, 2.0) + Math.Pow(B - b, 2.0) + Math.Pow(H - h, 2.0));
			double num18 = Math.Sqrt(Math.Pow((double)(L - a) - c, 2.0) + Math.Pow(B - b, 2.0) + Math.Pow(H - h, 2.0));
			double num19 = Math.Sqrt(Math.Pow((double)(L - a) - c, 2.0) + Math.Pow(H - h, 2.0));
			...
			double num23 = Math.Acos(c / num16);
			num2 = num4;
			num3 = num5;
			num4 = num2 + num16 * Math.Cos(num23);
			num5 = num3 + num16 * Math.Sin(num23);
			num22 = (ushort)(num + 1);
			num = num22;
			DrawLine(streamWriter, num22, text, num12 + num2, num13 + num3, num12 + num4, num13 + num5);
			if (zhyrFiltr == "ні")
			...
			else if (implementation1 == "ж/ф в середині зонта")
			{
				...
				num = DrawZaklepka_6_1(streamWriter, num, text, connection, num2 + num12, num3 + num13, num4 + num12, num5 + num13, z, 1);
			}
			else
			{
				num = DrawZaklepka_6_2(streamWriter, num, text, connection, num2 + num12, num3 + num13, num4 + num12, num5 + num13, 1);
			...
			num23 = Math.Acos(((double)L - c - (double)a) / num19);
			num2 = num4;
			num3 = num5;
			num4 = num2 - num19 * Math.Cos(num23);
			num5 = num3 + num19 * Math.Sin(num23);
			num22 = (ushort)(num + 1);
			num = num22;
			DrawLine(streamWriter, num22, text, num12 + num2, num13 + num3, num12 + num4, num13 + num5);
			if (zhyrFiltr == "ні")
			...
			else if (implementation1 == "ж/ф в середині зонта")
			{
				...
				num = DrawZaklepka_7_1(streamWriter, num, text, connection, num4 + num12, num5 + num13, num2 + num12, num3 + num13, z2, 1);
			}
			else
			{
				num = DrawZaklepka_7_2(streamWriter, num, text, connection, num4 + num12, num5 + num13, num2 + num12, num3 + num13, 1);
			...
			DrawLine(streamWriter, num22, text, num12 + num2, num13 + num3, num12 + num4, num13 + num5);
			num = DrawZaklepka_5(streamWriter, num, text, connection, num2 + num12, num3 + num13, num4 + num12, num5 + num13, 1);
			num23 = Math.Acos(c / num17);
			num2 = num4;
			num3 = num5;
			num4 = num2 + num17 * Math.Cos(num23);
			num5 = num3 + num17 * Math.Sin(num23);
			num22 = (ushort)(num + 1);
			num = num22;
			DrawLine(streamWriter, num22, text, num12 + num2, num13 + num3, num12 + num4, num13 + num5);
			if (zhyrFiltr == "ні")
			...
			{
				double z3 = ((double)H - (double)h - num20 - num21 / 2.0) * num16 / ((double)H - (double)h);
				num = DrawZaklepka_6_1(streamWriter, num, text, connection, num2 + num12, num3 + num13, num4 + num12, num5 + num13, z3, 1);
			}
			else
			{
				num = DrawZaklepka_6_2(streamWriter, num, text, connection, num2 + num12, num3 + num13, num4 + num12, num5 + num13, 1);
			...
			DrawLine(streamWriter, num22, text, num12 + num2, num13 + num3, num12 + num4, num13 + num5);
			num = DrawZaklepka_5(streamWriter, num, text, connection, num2 + num12, num3 + num13, num4 + num12, num5 + num13, 0);
			num23 = Math.Acos(((double)L - c - (double)a) / num18);
			num2 = num4;
			num3 = num5;
			num4 = num2 - num18 * Math.Cos(num23);
			num5 = num3 + num18 * Math.Sin(num23);
			num22 = (ushort)(num + 1);
			num = num22;
			DrawLine(streamWriter, num22, text, num12 + num2, num13 + num3, num12 + num4, num13 + num5);
			if (zhyrFiltr == "ні")
			...
			else if (implementation1 == "ж/ф в середині зонта")
			{
				...
				num = DrawZaklepka_7_1(streamWriter, num, text, connection, num4 + num12, num5 + num13, num2 + num12, num3 + num13, z4, 1);
			}
			else
			{
				num = DrawZaklepka_7_2(streamWriter, num, text, connection, num4 + num12, num5 + num13, num2 + num12, num3 + num13, 1);
			...
			num12 -= (double)(L + 100);
			double num24 = ((num16 > num19) ? num16 : num19);
			if (num17 > num24)
			{
				num24 = num17;
			}
			...
			num = num22;
			DrawLine(streamWriter, num22, text, num12 + num2, num13 + num3, num12 + num4, num13 + num5);
			num = DrawZaklepka_5_1(streamWriter, num, text, connection, num4 - num11 + num12, num5 + num13, num4 - num11 + num12, num5 + (double)h + num13, 1);
			double num25 = num4 - num11;
			double num26 = num5 + (double)h;
			num2 = num4;
			num3 = num5;
			num4 = num2 - num11;
			num5 += num11;
			...
			num3 = num5;
			num4 = num2;
			num5 = num3 + (double)h + num16 - 2.0 * num11;
			num22 = (ushort)(num + 1);
			num = num22;
			DrawLine(streamWriter, num22, text, num12 + num2, num13 + num3, num12 + num4, num13 + num5);
			if (zhyrFiltr == "ні")
			{
				num = DrawZaklepka_6_3(streamWriter, num, text, connection, num25 + num12, num26 + num13, num25 + num12, num5 + num11 + num13, 1);
			}
			else if (implementation1 == "ж/ф в середині зонта")
			{
				double z5 = ((double)H - (double)h - num20 - num21 / 2.0) * num16 / ((double)H - (double)h);
				num = DrawZaklepka_6(streamWriter, num, text, connection, num25 + num12, num26 + num13, num25 + num12, num5 + num11 + num13, z5, 1);
			}
			else
			{
				num = DrawZaklepka_6_3(streamWriter, num, text, connection, num25 + num12, num26 + num13, num25 + num12, num5 + num11 + num13, 1);
			...
			{
				num4 = num2 + ((double)B - num10) / 2.0 - num8;
				num5 = num3;
				num22 = (ushort)(num + 1);
				num = num22;
				DrawLine(streamWriter, num22, text, num12 + num2, num13 + num3, num12 + num4, num13 + num5);
			...
			DrawLine(streamWriter, num22, text, num12 + num2, num13 + num3, num12 + num4, num13 + num5);
			num25 = num4;
			num23 = Math.Acos((double)(B - b) / num17);
			double num27 = num11 * Math.Tan(num23);
			num2 = num4;
			num3 = num5;
			num4 = num2;
			num5 += (double)h - num11 - num27;
			num22 = (ushort)(num + 1);
			num = num22;
			DrawLine(streamWriter, num22, text, num12 + num2, num13 + num3, num12 + num4, num13 + num5);
			num2 = num4;
			...
			num = num22;
			DrawLine(streamWriter, num22, text, num12 + num2, num13 + num3, num12 + num4, num13 + num5);
			num = DrawZaklepka_5(streamWriter, num, text, connection, num25 + num12, num26 + num13, num25 + num12, num5 + num13, 0);
			num25 = num4;
			num26 = num5;
			num2 = num4;
			num3 = num5;
			num5 += num11 / Math.Cos(num23);
			num22 = (ushort)(num + 1);
			num = num22;
			DrawLine(streamWriter, num22, text, num12 + num2, num13 + num3, num12 + num4, num13 + num5);
			num2 = num4;
			num3 = num5;
			num4 = num2 - (num17 - num11) * Math.Cos(num23) + num11 * Math.Sin(num23);
			num5 = num3 + (num17 - num11) * Math.Sin(num23) + num11 * Math.Cos(num23) - num11 / Math.Cos(num23);
			num22 = (ushort)(num + 1);
			num = num22;
			DrawLine(streamWriter, num22, text, num12 + num2, num13 + num3, num12 + num4, num13 + num5);
			num2 = num4;
			num3 = num5;
			num4 = num25 - num17 * Math.Cos(num23);
			num5 = num26 + num17 * Math.Sin(num23);
			num22 = (ushort)(num + 1);
			num = num22;
			DrawLine(streamWriter, num22, text, num12 + num2, num13 + num3, num12 + num4, num13 + num5);
			if (zhyrFiltr == "ні")
			{
				num = DrawZaklepka_7_3(streamWriter, num, text, connection, num4 + num11 * Math.Sin(num23) + num12, num5 + num11 * Math.Cos(num23) + num13, num25 + num11 * Math.Sin(num23) + num12, num26 + num11 * Math.Cos(num23) + num13, 1);
			}
			else if (implementation1 == "ж/ф в середині зонта")
			{
				double z6 = (num20 + num21 / 2.0) * num17 / ((double)H - (double)h);
				num = DrawZaklepka_7(streamWriter, num, text, connection, num4 + num11 * Math.Sin(num23) + num12, num5 + num11 * Math.Cos(num23) + num13, num25 + num11 * Math.Sin(num23) + num12, num26 + num11 * Math.Cos(num23) + num13, z6, 1);
			}
			else
			{
				num = DrawZaklepka_7_3(streamWriter, num, text, connection, num4 + num11 * Math.Sin(num23) + num12, num5 + num11 * Math.Cos(num23) + num13, num25 + num11 * Math.Sin(num23) + num12, num26 + num11 * Math.Cos(num23) + num13, 1);
			...
			num3 = num5;
			num4 = num2;
			num5 = num3 + (double)h + num19 - 2.0 * num11;
			num22 = (ushort)(num + 1);
			num = num22;
			DrawLine(streamWriter, num22, text, num12 + num2, num13 + num3, num12 + num4, num13 + num5);
			if (zhyrFiltr == "ні")
			...
			{
				double z7 = ((double)H - (double)h - num20 - num21 / 2.0) * num19 / ((double)H - (double)h);
				num = DrawZaklepka_6(streamWriter, num, text, connection, num25 + num12, num26 + num13, num25 + num12, num5 + num11 + num13, z7, 1);
			}
			else
			{
				num = DrawZaklepka_6_3(streamWriter, num, text, connection, num25 + num12, num26 + num13, num25 + num12, num5 + num11 + num13, 1);
			...
			DrawLine(streamWriter, num22, text, num12 + num2, num13 + num3, num12 + num4, num13 + num5);
			num25 = num4;
			num23 = Math.Acos((double)(B - b) / num18);
			num27 = num11 * Math.Tan(num23);
			num2 = num4;
			num3 = num5;
			num4 = num2;
			num5 += (double)h - num11 - num27;
			...
			num2 = num4;
			num3 = num5;
			num4 = num2 - (num18 - num11) * Math.Cos(num23) + num11 * Math.Sin(num23);
			num5 = num3 + (num18 - num11) * Math.Sin(num23) + num11 * Math.Cos(num23) - num11 / Math.Cos(num23);
			num22 = (ushort)(num + 1);
			num = num22;
			DrawLine(streamWriter, num22, text, num12 + num2, num13 + num3, num12 + num4, num13 + num5);
			num2 = num4;
			num3 = num5;
			num4 = num25 - num18 * Math.Cos(num23);
			num5 = num26 + num18 * Math.Sin(num23);
			num22 = (ushort)(num + 1);
			num = num22;
			DrawLine(streamWriter, num22, text, num12 + num2, num13 + num3, num12 + num4, num13 + num5);
			if (zhyrFiltr == "ні")
			...
			{
				double z8 = (num20 + num21 / 2.0) * num18 / ((double)H - (double)h);
				num = DrawZaklepka_7(streamWriter, num, text, connection, num4 + num11 * Math.Sin(num23) + num12, num5 + num11 * Math.Cos(num23) + num13, num25 + num11 * Math.Sin(num23) + num12, num26 + num11 * Math.Cos(num23) + num13, z8, 1);
			}
			else
			{
				num = DrawZaklepka_7_3(streamWriter, num, text, connection, num4 + num11 * Math.Sin(num23) + num12, num5 + num11 * Math.Cos(num23) + num13, num25 + num11 * Math.Sin(num23) + num12, num26 + num11 * Math.Cos(num23) + num13, 1);
			...
			if (zhyrFiltr == "так")
			{
				if (implementation1 == "ж/ф внизу зонта (2 ряди)")
				{
					...
					else
					{
						...
						num35 = num4 + 5.0;
						num36 += num5;
						int num40 = (int)Math.Floor(((double)(L - 10) - num35) / (num39 + num37));
						for (int j = 0; j < num40; j++)
						{
							num2 = num35 + (double)j * (num39 + num37);
							num3 = num36;
							num4 = num2;
							num5 = num3 + num38;
							num22 = (ushort)(num + 1);
						...
						num2 = num33;
						num3 = num34;
						num4 = num2 + (double)L - 10.0 - (num32 + num30);
						num5 = num3;
						num22 = (ushort)(num + 1);
						num = num22;
						DrawLine(streamWriter, num22, text, num12 + num2, num13 + num3, num12 + num4, num13 + num5);
					...
					if (zhyrFiltr == "так" && zlyv != "ні")
					{
						...
						double num42 = 80.0;
						double num43 = 16.0;
						num2 = ((zlyv == "так, трубка справа") ? (num4 - num41) : (num4 - (double)(L - 5) + num41));
						num3 = num5 + num42;
						num22 = (ushort)(num + 1);
						num = num22;
						DrawCircle(streamWriter, num22, text, num12 + num2, num13 + num3, num43 / 2.0);
					}
					num2 = num4;
					num3 = num5;
				...
				else
				{
					...
					num2 = num4;
					num3 = num5;
					num4 = num2 + num48 / Math.Tan(Math.PI / 6.0);
					num5 = num3 + num48;
					num22 = (ushort)(num + 1);
					num = num22;
					DrawLine(streamWriter, num22, text, num12 + num2, num13 + num3, num12 + num4, num13 + num5);
					...
					double num50 = num2 + 35.0;
					num2 = num4;
					num3 = num5;
					num4 = num2 + (double)l + num49 - 2.0 * (num48 / Math.Tan(Math.PI / 6.0) + num47);
					num22 = (ushort)(num + 1);
					num = num22;
					DrawLine(streamWriter, num22, text, num12 + num2, num13 + num3, num12 + num4, num13 + num5);
					num22 = (ushort)(num + 1);
					num = num22;
					DrawCircle(streamWriter, num22, text, num12 + num2 + ((double)l + num49 - 2.0 * (num48 / Math.Tan(Math.PI / 6.0) + num47)) / 2.0, num13 + num5 - 10.0, d);
					num2 = num4;
					num3 = num5;
					num4 = num2 + num48 / Math.Tan(Math.PI / 6.0);
					num5 = num3 - num48;
					...
					num13 = a + 600;
					double num51 = 20.0;
					double num52 = 60.0 - num6 * Math.Cos(Math.PI / 4.0) / 2.0;
					double num53 = 15.0;
					double num54 = 35.0;
					num2 = kk - num52 - num6 * Math.Cos(Math.PI / 4.0) / 2.0;
					num3 = 0.0;
					num4 = num52 + num6 * Math.Cos(Math.PI / 4.0) / 2.0;
					num5 = num3;
					num22 = (ushort)(num + 1);
					num = num22;
					DrawLine(streamWriter, num22, text, num12 + num2, num13 + num3, num12 + num4, num13 + num5);
					...
					num2 = num4;
					num3 = num5;
					num4 = num2 - (num53 - num6 * Math.Cos(Math.PI / 4.0) / 2.0);
					num5 = num3 + (num53 - num6 * Math.Cos(Math.PI / 4.0) / 2.0);
					num22 = (ushort)(num + 1);
					num = num22;
					DrawLine(streamWriter, num22, text, num12 + num2, num13 + num3, num12 + num4, num13 + num5);
					num2 = num4;
					...
					num22 = (ushort)(num + 1);
					num = num22;
					DrawCircle(streamWriter, num22, text, num12 + num2 + 8.0, num13 + num3 + (num54 - 32.5) / 2.0, d);
					num22 = (ushort)(num + 1);
					num = num22;
					DrawCircle(streamWriter, num22, text, num12 + num2 + 8.0, num13 + num3 + (num54 + 32.5) / 2.0, d);
					num2 = num4;
					...
					num22 = (ushort)(num + 1);
					num = num22;
					DrawCircle(streamWriter, num22, text, num12 + num4 - 8.0, num13 + num5 + (num54 - 32.5) / 2.0, d);
					num22 = (ushort)(num + 1);
					num = num22;
					DrawCircle(streamWriter, num22, text, num12 + num4 - 8.0, num13 + num5 + (num54 + 32.5) / 2.0, d);
					num2 = num4;
	...
	public static void ZontPrystinnyyTyp31DrawImage(int L, int B, int H, int h, int a, int b, int p, double c, int number, string implementation, string zontMaterial, string tovchynaMetaluZont, string connection, string zlyv, string fastening, string typeFastening, string zhyrFiltr, string zhyrFiltrMaterial, string tovchynaMetaluFiltr, string orderCode, string contragent, string filePath = null)
	{
		...
		//IL_3a81: Expected O, but got Unknown
		int num = 725;
		int num2 = 1026;
		int num3 = 45;
		int num4 = 40;
		...
		try
		{
			...
			string text = "Зонт ЗВП-3.1 " + L + "х" + B + "х" + H;
			if (zhyrFiltr == "так")
			{
				text += " з ж/ф ";
			}
			...
			double num35 = Math.Sqrt(Math.Pow(c, 2.0) + Math.Pow(H - h, 2.0));
			double num36 = Math.Sqrt(Math.Pow(c, 2.0) + Math.Pow(B - b, 2.0) + Math.Pow(H - h, 2.0));
			double num37 = Math.Sqrt(Math.Pow((double)(L - a) - c, 2.0) + Math.Pow(B - b, 2.0) + Math.Pow(H - h, 2.0));
			double num38 = Math.Sqrt(Math.Pow((double)(L - a) - c, 2.0) + Math.Pow(H - h, 2.0));
			double num39 = num35 * num18;
			double num40 = num36 * num18;
			double num41 = num37 * num18;
			double num42 = num38 * num18;
			double num43 = num3;
			double num44 = (double)num6 + num32 * Math.Sin(num17);
			double num45 = num43 + num33;
			double num46 = num44;
			val2.DrawLine(val4, (float)num43, (float)num44, (float)num45, (float)num46);
			val2.DrawLine(val4, (float)num43, (float)num44, (float)num43, (float)num44 - (float)num23);
			val2.DrawLine(val4, (float)num43, (float)num44 - (float)num23, (float)num45, (float)num46 - (float)num23);
			val2.DrawLine(val4, (float)num45, (float)num46, (float)num45, (float)num46 - (float)num23);
			num45 = num43 + num32 * Math.Cos(num17);
			num46 = num6;
			val2.DrawLine(val4, (float)num43, (float)num44, (float)num45, (float)num46);
			val2.DrawLine(val4, (float)num43, (float)num44 - (float)num23, (float)num45, (float)num46 - (float)num23);
			val2.DrawLine(val4, (float)num45, (float)num46, (float)num45, (float)num46 - (float)num23);
			...
			val2.DrawLine(val4, (float)num43, (float)num44 - (float)num23, (float)num45, (float)num46 - (float)num23);
			val2.DrawLine(val4, (float)num45, (float)num46, (float)num45, (float)num46 - (float)num23);
			num43 = (double)num3 + num33;
			num44 = (double)num6 + num32 * Math.Sin(num17);
			val2.DrawLine(val4, (float)num43, (float)num44, (float)num45, (float)num46);
			val2.DrawLine(val4, (float)num43, (float)num44 - (float)num23, (float)num45, (float)num46 - (float)num23);
			num43 = num3;
			num44 = (double)num6 + num32 * Math.Sin(num17);
			num45 = num43;
			num46 = num44 + (num29 - num31);
			val2.DrawLine(val4, (float)num43, (float)num44, (float)num45, (float)num46);
			num43 = num45;
			num44 = num46;
			num45 = num43 + num30;
			...
			num43 = num45;
			num44 = num46;
			num45 = (double)num3 + num33;
			num46 = num44 - (num29 - num31);
			val2.DrawLine(val4, (float)num43, (float)num44, (float)num45, (float)num46);
			num45 = num43 + num28 * Math.Cos(num17);
			num46 = num44 - num28 * Math.Sin(num17);
			val2.DrawLine(val4, (float)num43, (float)num44, (float)num45, (float)num46);
			val2.DrawLine(val4, (float)num43 - (float)num30, (float)num44, (float)num45 - (float)num30, (float)num46);
			val2.DrawLine(val4, (float)num43 - (float)num30, (float)num44 + (float)num31, (float)num45 - (float)num30, (float)num46 + (float)num31);
			val2.DrawLine(val4, (float)num45 - (float)num30, (float)num46, (float)num45 - (float)num30, (float)num46 + (float)num31);
			num43 = num45;
			num44 = num46;
			num45 = (double)num3 + num32 * Math.Cos(num17) + num33;
			num46 = num6;
			val2.DrawLine(val4, (float)num43, (float)num44, (float)num45, (float)num46);
			num45 = num43 - num30;
			num46 = num44;
			val2.DrawLine(val4, (float)num43, (float)num44, (float)num45, (float)num46);
			val2.DrawLine(val4, (float)num43, (float)num44 + (float)num31, (float)num45, (float)num46 + (float)num31);
			num43 = num45;
			num44 = num46;
			num45 = (double)num3 + num32 * Math.Cos(num17);
			num46 = num6;
			val2.DrawLine(val4, (float)num43, (float)num44, (float)num45, (float)num46);
			num43 = num3;
			num44 = (double)num6 + num32 * Math.Sin(num17) + num29 - num31;
			num45 = num43;
			num46 = num44 + num31;
			val2.DrawLine(val4, (float)num43, (float)num44, (float)num45, (float)num46);
			num43 = num45;
			...
			num44 = num46 - num31;
			val2.DrawLine(val4, (float)num43, (float)num44, (float)num45, (float)num46);
			num43 = num45 + num28 * Math.Cos(num17);
			num44 = num46 - num28 * Math.Sin(num17);
			val2.DrawLine(val4, (float)num43, (float)num44, (float)num45, (float)num46);
			num45 = num43;
			num46 = num44 - num31;
			val2.DrawLine(val4, (float)num43, (float)num44, (float)num45, (float)num46);
			...
			num46 = num44 - num23;
			DrawRows(num43, num44, num45, num46, num18, val2, val3);
			num47 = num43 - (double)(2 * num21);
			num48 = (num44 + num46) / 2.0;
			if (implementation == "ж/ф в середині зонта")
			{
				num48 -= (double)(num21 / 2);
			}
			#if WINDOWS
			val9.FormatFlags = (StringFormatFlags)2;
			#endif
			val2.DrawString(num22.ToString(), val7, (Brush)(object)val8, (float)num47, (float)num48, val9);
			num43 = num3;
			num44 = (double)num6 + num32 * Math.Sin(num17) + num29;
			num45 = num43;
			num46 = num44 + (double)num14;
			val2.DrawLine(val3, (float)num43, (float)num44, (float)num45, (float)num46);
			num43 = (double)num3 + num30;
			num44 = (double)num6 + num32 * Math.Sin(num17) + num29;
			num45 = num43;
			num46 = num44 + (double)num14;
			val2.DrawLine(val3, (float)num43, (float)num44, (float)num45, (float)num46);
			num43 = num3;
			num44 = (double)num6 + num32 * Math.Sin(num17) + num29 + (double)num14 - 5.0;
			num45 = num43 + num30;
			num46 = num44;
			DrawRows(num43, num44, num45, num46, num18, val2, val3);
			num47 = (num43 + num45) / 2.0;
			num48 = num46 + (double)num21;
			#if WINDOWS
			val9.FormatFlags = (StringFormatFlags)1;
			#endif
			val2.DrawString(B.ToString(), val7, (Brush)(object)val8, (float)num47, (float)num48, val9);
			num43 = (double)num3 + num30 + num28 * Math.Cos(num17);
			num44 = (double)num6 + num32 * Math.Sin(num17) + num29 - num28 * Math.Sin(num17);
			num45 = num43;
			num46 = num44 + (double)num14;
			val2.DrawLine(val3, (float)num43, (float)num44, (float)num45, (float)num46);
			num43 = num45;
			...
			num47 = (num43 + num45) / 2.0;
			num48 = (num44 + num46) / 2.0 + 15.0 + 5.0;
			#if WINDOWS
			val9.FormatFlags = (StringFormatFlags)1;
			#endif
			...
			num46 = num44;
			val2.DrawLine(val3, (float)num43, (float)num44, (float)num45, (float)num46);
			num43 = (double)num3 + num30 + num28 * Math.Cos(num17) + (double)num14 - 5.0;
			num44 = (double)num6 + num32 * Math.Sin(num17) + num29 - num28 * Math.Sin(num17);
			num45 = num43;
			num46 = num44 - num31;
			DrawRows(num45, num46, num43, num44, num18, val2, val3);
			num47 = num43 + (double)num21;
			num48 = (num44 + num46) / 2.0;
			#if WINDOWS
			val9.FormatFlags = (StringFormatFlags)2;
			#endif
			...
			double num50 = num46;
			val2.DrawLine(val3, (float)num43, (float)num44, (float)num45, (float)num46);
			num43 += num32 * Math.Cos(num17);
			num44 = num6;
			num45 = num43 + (double)num14 * Math.Sin(num17);
			num46 = num44 + (double)num14 * Math.Cos(num17);
			val2.DrawLine(val3, (float)num43, (float)num44, (float)num45, (float)num46);
			num43 = num49 - 5.0 * Math.Sin(num17);
			num44 = num50 - 5.0 * Math.Cos(num17);
			num45 -= 5.0 * Math.Sin(num17);
			num46 -= 5.0 * Math.Cos(num17);
			DrawRows(num43, num44, num45, num46, num18, val2, val3);
			num47 = (num43 + num45) / 2.0 + (double)num21;
			num48 = (num44 + num46) / 2.0 + (double)num21;
			#if WINDOWS
			val9.FormatFlags = (StringFormatFlags)1;
			#endif
			val2.DrawString(a.ToString(), val7, (Brush)(object)val8, (float)num47, (float)num48, val9);
			num43 = num3;
			num44 = (double)num6 + num32 * Math.Sin(num17) + num29 - num31;
			num45 = num43;
			num46 = (double)num6 + num32 * Math.Sin(num17);
			num47 = (num43 + num45) / 2.0 - 1.5 * (double)num21;
			num48 = (num44 + num46) / 2.0;
			#if WINDOWS
			val9.FormatFlags = (StringFormatFlags)1;
			#endif
			val2.DrawString(Math.Round(num35, MidpointRounding.AwayFromZero).ToString(), val7, (Brush)(object)val8, (float)num47, (float)num48, val9);
			num43 = (double)num3 + num30;
			num44 = (double)num6 + num32 * Math.Sin(num17) + num29 - num31;
			num45 = num43 - (num30 - num33);
			num46 = (double)num6 + num32 * Math.Sin(num17);
			num47 = (num43 + num45) / 2.0 + 1.5 * (double)num21;
			num48 = (num44 + num46) / 2.0;
			#if WINDOWS
			val9.FormatFlags = (StringFormatFlags)1;
			#endif
			val2.DrawString(Math.Round(num36, MidpointRounding.AwayFromZero).ToString(), val7, (Brush)(object)val8, (float)num47, (float)num48, val9);
			num43 = (double)num3 + num30 + num28 * Math.Cos(num17);
			num44 = (double)num6 + num32 * Math.Sin(num17) - (num28 * Math.Sin(num17) - (num29 - num31));
			num45 = (double)num3 + num33 + num32 * Math.Sin(num17);
			num46 = num6;
			num47 = (num43 + num45) / 2.0 + (double)num21;
			num48 = (num44 + num46) / 2.0 - (double)num21;
			#if WINDOWS
			val9.FormatFlags = (StringFormatFlags)1;
			#endif
			val2.DrawString(Math.Round(num37, MidpointRounding.AwayFromZero).ToString(), val7, (Brush)(object)val8, (float)num47, (float)num48, val9);
			num43 -= num30;
			num45 -= num33;
			num46 = num6;
			num47 = (num43 + num45) / 2.0 + (double)num21;
			...
			val9.FormatFlags = (StringFormatFlags)1;
			#endif
			val2.DrawString(Math.Round(num38, MidpointRounding.AwayFromZero).ToString(), val7, (Brush)(object)val8, (float)num47, (float)num48, val9);
			double num51 = Math.Atan((double)(H - h) / c);
			double num52 = Math.Atan((double)(H - h) / ((double)L - c - (double)a));
			double num53 = Math.PI / 2.0;
			double num54 = Math.Atan((double)(H - h) / (double)(B - b));
			double num55 = 0.0;
			double num56 = (double)L * Math.Sqrt(Math.Pow(num35, 2.0) - Math.Pow(c, 2.0)) / num35;
			double num57 = Math.Sqrt(Math.Pow(L, 2.0) - Math.Pow(num56, 2.0));
			double a2 = Math.Acos(num55 / num35);
			...
			double num59 = Math.Round(180.0 * Math.Acos((Math.Pow(num58, 2.0) + Math.Pow(num56, 2.0) - Math.Pow(x2, 2.0)) / (2.0 * num58 * num56)) / Math.PI, MidpointRounding.AwayFromZero);
			num58 = (double)B * Math.Sqrt(Math.Pow(num36, 2.0) - Math.Pow((double)B - num55 - (double)b, 2.0)) / num36;
			double num60 = Math.Sqrt(Math.Pow(B, 2.0) - Math.Pow(num58, 2.0));
			a2 = Math.Acos(c / num36);
			num56 = num60 * Math.Tan(a2);
			x = Math.Sqrt(Math.Pow(num60, 2.0) + Math.Pow(num56, 2.0));
			x2 = Math.Sqrt(Math.Pow(B, 2.0) + Math.Pow(x, 2.0));
			double num61 = Math.Round(180.0 * Math.Acos((Math.Pow(num58, 2.0) + Math.Pow(num56, 2.0) - Math.Pow(x2, 2.0)) / (2.0 * num58 * num56)) / Math.PI, MidpointRounding.AwayFromZero);
			num58 = (double)L * Math.Sqrt(Math.Pow(num37, 2.0) - Math.Pow((double)L - c - (double)a, 2.0)) / num37;
			double num62 = Math.Sqrt(Math.Pow(L, 2.0) - Math.Pow(num58, 2.0));
			a2 = Math.Acos(((double)B - num55 - (double)b) / num37);
			num56 = num62 * Math.Tan(a2);
			x = Math.Sqrt(Math.Pow(num62, 2.0) + Math.Pow(num56, 2.0));
			x2 = Math.Sqrt(Math.Pow(L, 2.0) + Math.Pow(x, 2.0));
			double num63 = Math.Round(180.0 * Math.Acos((Math.Pow(num58, 2.0) + Math.Pow(num56, 2.0) - Math.Pow(x2, 2.0)) / (2.0 * num58 * num56)) / Math.PI, MidpointRounding.AwayFromZero);
			num58 = (double)L * Math.Sqrt(Math.Pow(num38, 2.0) - Math.Pow((double)L - c - (double)a, 2.0)) / num38;
			double num64 = Math.Sqrt(Math.Pow(L, 2.0) - Math.Pow(num58, 2.0));
			a2 = Math.Acos(num55 / num38);
			num56 = num64 * Math.Tan(a2);
			x = Math.Sqrt(Math.Pow(num64, 2.0) + Math.Pow(num56, 2.0));
			x2 = Math.Sqrt(Math.Pow(L, 2.0) + Math.Pow(x, 2.0));
			double num65 = Math.Round(180.0 * Math.Acos((Math.Pow(num58, 2.0) + Math.Pow(num56, 2.0) - Math.Pow(x2, 2.0)) / (2.0 * num58 * num56)) / Math.PI, MidpointRounding.AwayFromZero);
			if (c == 0.0)
			{
				num59 = 90.0;
				num61 = 90.0;
			...
			double num66 = 20.0;
			double num67 = Math.PI / 2.0;
			num43 = (double)num3 + num30 / 2.0;
			num44 = (double)num6 + num32 * Math.Sin(num17) + num29 - num31;
			num45 = num43 + num66 * Math.Cos(num67);
			num46 = num44 - num66 * Math.Sin(num67);
			val2.DrawLine(val3, (float)num43, (float)num44, (float)num45, (float)num46);
			num45 = num43 + num66 * Math.Cos(num17);
			num46 = num44 - num66 * Math.Sin(num17);
			val2.DrawLine(val3, (float)num43, (float)num44, (float)num45, (float)num46);
			num43 = (double)num3 + num30 / 2.0 + num66 * Math.Cos(num67) / 2.0;
			num44 = (double)num6 + num32 * Math.Sin(num17) + num29 - num31 - num66 * Math.Sin(num67) / 2.0;
			...
			num45 = (num43 + num68) / 2.0 + num66 / 2.0;
			num46 = (num44 + num69) / 2.0 - num66 / 2.0;
			val2.DrawBezier(val3, (float)num68, (float)num69, (float)num45, (float)num46, (float)num43, (float)num44, (float)num43, (float)num44);
			num51 = Math.Round(180.0 * num51 / Math.PI, MidpointRounding.AwayFromZero);
			num51 = 90.0 - num51;
			#if WINDOWS
			val9.FormatFlags = (StringFormatFlags)1;
			#endif
			val2.DrawString(num51 + "°", val7, (Brush)(object)val8, (float)(num45 + 5.0), (float)num46 - 5f, val9);
			#if WINDOWS
			val9.FormatFlags = (StringFormatFlags)2;
			#endif
			num43 = (double)num3 + num30 + num28 * Math.Cos(num17) / 2.0;
			num44 = (double)num6 + num32 * Math.Sin(num17) + num29 - num31 - num28 * Math.Sin(num17) / 2.0;
			num45 = num43 - num66;
			num46 = num44;
			val2.DrawLine(val3, (float)num43, (float)num44, (float)num45, (float)num46);
			num45 = num43 - num66 * Math.Sin(num17);
			num46 = num44 - num66 * Math.Cos(num17);
			val2.DrawLine(val3, (float)num43, (float)num44, (float)num45, (float)num46);
			num43 = (double)num3 + num30 + num28 * Math.Cos(num17) / 2.0 - num66 / 2.0;
			num44 = (double)num6 + num32 * Math.Sin(num17) + num29 - num31 - num28 * Math.Sin(num17) / 2.0;
			num68 = (double)num3 + num30 + num28 * Math.Cos(num17) / 2.0 - num66 * Math.Sin(num17) / 2.0;
			num69 = num44 - num66 * Math.Cos(num17) / 2.0;
			num45 = (num43 + num68) / 2.0 - num66 / 2.0;
			num46 = (num44 + num69) / 2.0 - num66 / 2.0;
			val2.DrawBezier(val3, (float)num68, (float)num69, (float)num45, (float)num46, (float)num43, (float)num44, (float)num43, (float)num44);
			...
			val9.FormatFlags = (StringFormatFlags)1;
			#endif
			val2.DrawString(num54 + "°", val7, (Brush)(object)val8, (float)(num45 - 5.0), (float)num46, val9);
			#if WINDOWS
			val9.FormatFlags = (StringFormatFlags)2;
			#endif
			num67 = Math.Acos(((double)L - c - (double)a) / num38);
			num43 = (double)num3 + num30 / 2.0 + num28 * Math.Cos(num17);
			num44 = (double)num6 + num32 * Math.Sin(num17) + num29 - num31 - num28 * Math.Sin(num17);
			num45 = num43 - num66 * Math.Cos(num67 - num17);
			num46 = num44 + num66 * Math.Sin(num67 - num17);
			val2.DrawLine(val3, (float)num43, (float)num44, (float)num45, (float)num46);
			num45 = num43 - num66 * Math.Cos(num17);
			num46 = num44 - num66 * Math.Sin(num17);
			val2.DrawLine(val3, (float)num43, (float)num44, (float)num45, (float)num46);
			num43 = (double)num3 + num30 / 2.0 + num28 * Math.Cos(num17) - num66 * Math.Cos(num67 - num17) / 2.0;
			num44 += num66 * Math.Sin(num67 - num17) / 2.0;
			...
			val9.FormatFlags = (StringFormatFlags)1;
			#endif
			val2.DrawString(num52 + "°", val7, (Brush)(object)val8, (float)(num45 - 5.0), (float)num46, val9);
			#if WINDOWS
			val9.FormatFlags = (StringFormatFlags)2;
			#endif
			num67 = Math.PI / 2.0;
			num43 = (double)num3 + 2.0 * num66 * Math.Cos(num67);
			num44 = (double)num6 + num32 * Math.Sin(num17) + num29 - num31 - 2.0 * num66 * Math.Sin(num67);
			num45 = num43 + num66 * Math.Cos(num17);
			num46 = num44 - num66 * Math.Sin(num17);
			val2.DrawLine(val3, (float)num43, (float)num44, (float)num45, (float)num46);
			num45 = num43 + num66;
			num46 = num44;
			val2.DrawLine(val3, (float)num43, (float)num44, (float)num45, (float)num46);
			num43 = (double)num3 + 2.0 * num66 * Math.Cos(num67) + num66 * Math.Cos(num17) / 2.0;
			num44 = (double)num6 + num32 * Math.Sin(num17) + num29 - num31 - 2.0 * num66 * Math.Sin(num67) - num66 * Math.Sin(num17) / 2.0;
			...
			val9.FormatFlags = (StringFormatFlags)1;
			#endif
			val2.DrawString(num59 + "°", val7, (Brush)(object)val8, (float)(num45 + 10.0), (float)(num46 + 3.0), val9);
			#if WINDOWS
			val9.FormatFlags = (StringFormatFlags)2;
			#endif
			num67 = Math.Atan((double)(H - h) / (double)(B - b));
			num43 = (double)num3 + num30 - 2.0 * num66 * Math.Cos(num67);
			num44 = (double)num6 + num32 * Math.Sin(num17) + num29 - num31 - 2.0 * num66 * Math.Sin(num67);
			num45 = num43 - num66 * Math.Cos(num17);
			num46 = num44 - num66 * Math.Sin(num17);
			val2.DrawLine(val3, (float)num43, (float)num44, (float)num45, (float)num46);
			...
			num46 = num44;
			val2.DrawLine(val3, (float)num43, (float)num44, (float)num45, (float)num46);
			num43 = (double)num3 + num30 - 2.0 * num66 * Math.Cos(num67) - num66 * Math.Cos(num17) / 2.0;
			num44 = (double)num6 + num32 * Math.Sin(num17) + num29 - num31 - 2.0 * num66 * Math.Sin(num67) - num66 * Math.Sin(num17) / 2.0;
			...
			val9.FormatFlags = (StringFormatFlags)1;
			#endif
			val2.DrawString(num61 + "°", val7, (Brush)(object)val8, (float)(num45 - 10.0), (float)(num46 + 3.0), val9);
			#if WINDOWS
			val9.FormatFlags = (StringFormatFlags)2;
			#endif
			num43 = ((double)num3 + num30 + num28 * Math.Cos(num17) + ((double)num3 + num33 + num32 * Math.Cos(num17))) / 2.0;
			num44 = ((double)(num6 + num6) + num32 * Math.Sin(num17) + num29 - num31 - num28 * Math.Sin(num17)) / 2.0;
			num45 = num43 - num66 * Math.Cos(num17);
			num46 = num44 + num66 * Math.Sin(num17);
			val2.DrawLine(val3, (float)num43, (float)num44, (float)num45, (float)num46);
			num45 = num43 - num66;
			num46 = num44;
			val2.DrawLine(val3, (float)num43, (float)num44, (float)num45, (float)num46);
			num43 = ((double)num3 + num30 + num28 * Math.Cos(num17) + ((double)num3 + num33 + num32 * Math.Cos(num17))) / 2.0 - num66 * Math.Cos(num17) / 2.0;
			num44 = ((double)(num6 + num6) + num32 * Math.Sin(num17) + num29 - num31 - num28 * Math.Sin(num17)) / 2.0 + num66 * Math.Sin(num17) / 2.0;
			num68 = ((double)num3 + num30 + num28 * Math.Cos(num17) + ((double)num3 + num33 + num32 * Math.Cos(num17))) / 2.0 - num66 / 2.0;
			...
			val9.FormatFlags = (StringFormatFlags)1;
			#endif
			val2.DrawString(num63 + "°", val7, (Brush)(object)val8, (float)(num45 - 10.0), (float)(num46 + 3.0), val9);
			#if WINDOWS
			val9.FormatFlags = (StringFormatFlags)2;
			#endif
			num43 = ((double)num3 + num28 * Math.Cos(num17) + ((double)num3 + num32 * Math.Cos(num17))) / 2.0;
			num44 = ((double)(num6 + num6) + num32 * Math.Sin(num17) + num29 - num31 - num28 * Math.Sin(num17)) / 2.0;
			num45 = num43 - num66 * Math.Cos(num17);
			num46 = num44 + num66 * Math.Sin(num17);
			val2.DrawLine(val3, (float)num43, (float)num44, (float)num45, (float)num46);
			...
			num46 = num44;
			val2.DrawLine(val3, (float)num43, (float)num44, (float)num45, (float)num46);
			num43 = ((double)num3 + num28 * Math.Cos(num17) + ((double)num3 + num32 * Math.Cos(num17))) / 2.0 - num66 * Math.Cos(num17) / 2.0;
			num44 = ((double)(num6 + num6) + num32 * Math.Sin(num17) + num29 - num31 - num28 * Math.Sin(num17)) / 2.0 + num66 * Math.Sin(num17) / 2.0;
			num68 = ((double)num3 + num28 * Math.Cos(num17) + ((double)num3 + num32 * Math.Cos(num17))) / 2.0 + num66 / 2.0;
			num69 = ((double)(num6 + num6) + num32 * Math.Sin(num17) + num29 - num31 - num28 * Math.Sin(num17)) / 2.0;
			num45 = (num43 + num68) / 2.0 + num66 / 2.0;
			num46 = (num44 + num69) / 2.0 + num66 / 2.0;
			val2.DrawBezier(val3, (float)num68, (float)num69, (float)num45, (float)num46, (float)num43, (float)num44, (float)num43, (float)num44);
			...
			val9.FormatFlags = (StringFormatFlags)1;
			#endif
			val2.DrawString(num65 + "°", val7, (Brush)(object)val8, (float)(num45 - 5.0), (float)(num46 + 3.0), val9);
			#if WINDOWS
			val9.FormatFlags = (StringFormatFlags)2;
			#endif
			double num94;
			...
			if (zhyrFiltr == "так")
			{
				if (implementation == "ж/ф внизу зонта (2 ряди)")
				{
					...
					num46 = num44 - num81;
					val2.DrawLine(val5, (float)num43, (float)num44, (float)num45, (float)num46);
					num43 = (double)num3 + num30 / 2.0 - num76 / 2.0;
					num44 = (double)num6 + num32 * Math.Sin(num17) + num29;
					num45 = num43 + num76;
					num46 = num44;
					val2.DrawLine(val5, (float)num43, (float)num44, (float)num45, (float)num46);
					...
					double num83 = 3.0;
					num43 = (double)num3 + num30 / 2.0;
					num44 = (double)num6 + num32 * Math.Sin(num17) + num29 - num82;
					num45 = num43 + num79;
					num46 = num44;
					val2.DrawLine(val5, (float)num43, (float)num44, (float)num45, (float)num46);
					num45 = num43;
					...
					num43 = (double)num3 + num87 + num83;
					num44 = (double)num6 + num32 * Math.Sin(num17) + num29 - num81 - num82;
					num45 = num43 + num88 - 2.0 * num83;
					num46 = num44;
					val2.DrawLine(val5, (float)num43, (float)num44, (float)num45, (float)num46);
					num45 = num43;
					num46 = num44 - num85;
					val2.DrawLine(val5, (float)num43, (float)num44, (float)num45, (float)num46);
					num43 += num88 - 2.0 * num83;
					num45 = num43;
					num46 = num44 - num85;
					val2.DrawLine(val5, (float)num43, (float)num44, (float)num45, (float)num46);
					num44 = num46;
					num45 = num43 - (num88 - 2.0 * num83);
					val2.DrawLine(val5, (float)num43, (float)num44, (float)num45, (float)num46);
					num43 = (double)num3 + num30 / 2.0 + num87 + num83;
					num44 = (double)num6 + num32 * Math.Sin(num17) + num29 - num81 - num82;
					num45 = num43 + num88 - 2.0 * num83;
					num46 = num44;
					val2.DrawLine(val5, (float)num43, (float)num44, (float)num45, (float)num46);
					...
					num46 = num95 - 5.0;
					DrawRows(num43, num44, num45, num46, num18, val2, val3);
					num47 = (num49 + num94) / 2.0;
					num48 = num50 + (double)num21;
					#if WINDOWS
					val9.FormatFlags = (StringFormatFlags)1;
					#endif
					val2.DrawString(num70.ToString(), val7, (Brush)(object)val8, (float)num47, (float)num48, val9);
					num43 = num90 + num76;
					num44 = num91;
					num45 = num43;
					num46 = num44 - num77;
					...
					num46 = num44 - num77;
					DrawRows(num43, num44, num45, num46, num18, val2, val3);
					num47 = num43 - (double)num21 - 3.0;
					num48 = (num44 + num46) / 2.0;
					#if WINDOWS
					val9.FormatFlags = (StringFormatFlags)1;
					#endif
					val2.DrawString(num71.ToString(), val7, (Brush)(object)val8, (float)num47, (float)num48, val9);
					num43 = num92 - num76 - 2.0 * num79;
					num44 = num93;
					num45 = num43;
					num46 = num44 + num78;
					val2.DrawLine(val5, (float)num43, (float)num44, (float)num45, (float)num46);
					...
					val9.FormatFlags = (StringFormatFlags)1;
					#endif
					val2.DrawString(num72.ToString(), val7, (Brush)(object)val8, (float)num47, (float)num48, val9);
					num43 = num92 - num76 - 2.0 * num79;
					num44 = num93 + num78;
					num45 = num43 + num79;
					num46 = num44;
					...
					val2.DrawLine(val3, (float)num43, (float)num44, (float)num45, (float)num46);
					num43 = num92 - num76 - 2.0 * num79;
					num44 = num93 + num78 + (double)num15 - 5.0;
					num45 = num43 + num79;
					num46 = num44;
					DrawRows(num45, num46, num43, num44, num18, val2, val3);
					num47 = (num43 + num45) / 2.0;
					...
					val9.FormatFlags = (StringFormatFlags)1;
					#endif
					val2.DrawString(num73.ToString(), val7, (Brush)(object)val8, (float)num47, (float)num48, val9);
				}
				else
				{
					int num96 = 130;
					...
					num43 = (double)num3 + num103 / 2.0;
					num44 = (double)num6 + num32 * Math.Sin(num17) + num101;
					num45 = num43 + num102;
					num46 = num44;
					val2.DrawLine(val5, (float)num43, (float)num44, (float)num45, (float)num46);
					num45 = num43;
					...
					num46 = num44;
					val2.DrawLine(val3, (float)num43, (float)num44, (float)num45, (float)num46);
					num43 = (double)num3 - num103 / 2.0 + 5.0;
					num44 = (double)num6 + num32 * Math.Sin(num17);
					num45 = num43;
					num46 = num44 + num101;
					DrawRows(num43, num44, num45, num46, num18, val2, val3);
					...
					val9.FormatFlags = (StringFormatFlags)2;
					#endif
					val2.DrawString(Math.Round(num98, MidpointRounding.AwayFromZero).ToString(), val7, (Brush)(object)val8, (float)num47, (float)num48, val9);
				}
			}
			...
			DrawRows(num43, num44, num45, num46, num19, val2, val3);
			num47 = (num49 + num94) / 2.0;
			num48 = (num50 + num95) / 2.0 + (double)num21;
			#if WINDOWS
			val9.FormatFlags = (StringFormatFlags)1;
			#endif
			val2.DrawString(L.ToString(), val7, (Brush)(object)val8, (float)num47, (float)num48, val9);
			...
			val9.FormatFlags = (StringFormatFlags)1;
			#endif
			val2.DrawString(c.ToString(), val7, (Brush)(object)val8, (float)num47, (float)num48, val9);
			num43 = num8 + num34;
			num44 = num9;
			num45 = num43 + num32;
			num46 = num44;
			...
			num44 = num9 + num30;
			num45 = num43 + num34;
			num46 = num44 - (num30 - num33);
			val2.DrawLine(val4, (float)num43, (float)num44, (float)num45, (float)num46);
			num43 = num8 + num28;
			num44 = num9;
			num45 = num43 - (num28 - num34 - num32);
			num46 = num44;
			val2.DrawLine(val4, (float)num43, (float)num44, (float)num45, (float)num46);
			num43 = num8 + num28;
			num44 = num9 + num30;
	...
	public static double VolumeZontPrystinnyyTyp31(int L, int B, int H, int p)
	{
		return Math.Round((double)L * (double)B * (double)(H + p) / 1000000.0) / 1000.0;
	}
}
